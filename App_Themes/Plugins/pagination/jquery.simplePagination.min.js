...
function ASG() {
    var o = edu.system,
        t = JSON.parse(AD($("#myTextBox").val(), "AzzS"));
    o.objApi = Init_API();
    //try {
    //    o["iM"] = "AzzSystem";
    //    o["iShk"] = false;
    //    var check = localStorage.getItem("iShk");
    //    if (check == "true") o.iShk = true;
    ...
    -1 !== a.indexOf("localhost:") && (a = location.protocol + "//" + location.hostname),
        (o.strhost = a),
        (o.rootPath = a + t.rootPath),
        (o.rootPathUpload = t.rootPathUpload),
        (o.rootPathReport = t.rootPathReport),
        (o.apiUrl = a + t.rootPathAPI),
        (o.apiUrlTemp = a),
        (o.folderAvatar = t.folderAvatar),
        (o.folderDoc = t.folderDoc),
        (o.clientIP = t.clientIP),
        (o.appId = t.appId),
        (o.userId = t.userId),
        (o.langId = t.langId);
    var r = o.getBrowser();
    (o.browsername = r.name),
        (o.tokenJWT = t.tokenJWT),
        -1 === o.rootPathUpload.indexOf("http") && (o.rootPathUpload = a + o.rootPathUpload);
    var e = "";
    (e = edu.util.checkValue(t.avatar)
        ? o.rootPathUpload + "/Core/images/no-avatar.png"
        : o.rootPathUpload + "/Core/images/no-avatar.png"),
        $("#imgavatar").attr("src", e),
        $("#imgavatardrop").attr("sc", e),
        (o.appCode = $("#lbLogo_mini").html()),
        $('a[data-toggle="control-sidebar"]').click(function () {
            sessionStorage.removeItem("objUserVT");
        });
    var s = sessionStorage.getItem("objUserVT");
    if (s)
        try {
            s = AD(s, "31415926535");
            var p = JSON.parse(s);
            (o.userId = p.userId),
                (o.appId = p.appId),
                (o.appCode = p.appCode),
                (o.rootPathReport = p.rootPathReport),
                (e = p.userAvartar),
                $("#imgavatar").attr("src", e),
                $("#imgavatardrop").attr("src", e),
                o.getlistByUser_ChucNang(),
                $("#lbLogo_large").html(p.lbLogo_large),
                (document.title = p.lbLogo_large);
        } catch {
            (p = {
                userId: o.userId,
                appId: o.appId,
                appCode: o.appCode,
                rootPathReport: o.rootPathReport,
                userAvartar: $("#imgavatar").attr("src"),
                lbLogo_large: $("#lbLogo_large").html(),
            }),
                sessionStorage.setItem("objUserVT", AE(JSON.stringify(p), "31415926535")),
                o.getlistByUser_ChucNang();
        }
    else
        (p = {
    ...
    var l = o.userId;
    !(function t() {
        l != o.userId && (sessionStorage.removeItem("objUserVT"), (location.href = "Logout.aspx"));
        setTimeout(function () {
            t();
        }, 1e3);
    })();
