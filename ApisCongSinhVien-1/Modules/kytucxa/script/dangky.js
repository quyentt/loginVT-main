        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    obj = {
                        title: "",
                        content: "Đăng ký thành công! Vui lòng chờ cán bộ xác nhận.",
                        code: ""
                    };
        ...
        var jsonForm = {
            ...
            aoColumns: [
                ...
                , {
                    "mData": "cancel",
                    "mRender": function (nRow, aData) {
                        return '<a title="Sửa" class="btn btn-default color-active btnCancel" id="cancel' + aData.KTX_PHONG_MA + '" href="#"><i class="fa fa-minus-circle"></i></a>';
                    }
                }
            ]
        };
