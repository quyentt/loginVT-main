...
--Note:
----------------------------------------------*/
function ChiTiet_TongMien() { };
ChiTiet_TongMien.prototype = {
    strUser_Id: '',
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genHTML_TongMien: function (data) {
        var me = this;
        ...
        var jsonForm = {
            ...
            aoColumns: [//LOAIKHOAN_MA LOAIKHOAN_TEN
                ...
                , {
                    "mRender": function (nRow, aData) {
                        return '<span class="color-active">' + aData.PHANTRAMMIEN + '</span>';
                    }
                }
            ]
        };
