...
--Note:
----------------------------------------------*/
function ChiTiet_TongDaNop() { };
ChiTiet_TongDaNop.prototype = {
    strUser_Id: '',
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genHTML_TongDaNop: function (data) {
        var me = this;
        ...
        var jsonForm = {
            ...
            aoColumns: [
                    ...
                    "mRender": function (nRow, aData) {
                        ...
                        switch (strLoaiKhoan_Ma) {
                            ...
                            case "KINHPHI":
                                ...
                                break;
                            default:
                                return '<span class="label label-default">' + aData.LOAIKHOAN_TEN + '</span>';
                        }
                    }
                },
                {
                ...
                {
                    "mRender": function (nRow, aData) {
                        return '<span>' + edu.util.returnEmpty(aData.NOIDUNG) + '</span>';
                    }
                }
                , {
