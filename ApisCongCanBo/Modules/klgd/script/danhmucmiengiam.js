function danhmucmiengiam() { };
danhmucmiengiam.prototype = {
    dtDanhMucMienGiam:[],     
    strErr: '', 
    strMienGiamId:'',
    ...
    getList_tblDanhMucMienGiam: function () {
        ...
        var obj_list = {
            'action': 'TKGG_KLGD/GetDanhsachMienGiam',
            'versionAPI': 'v1.0',  
    ...
    CapNhatMienGiam: function () {
        ...
        var obj_list = {
            'action': 'TKGG_KLGD/CapNhatMienGiam',
            'versionAPI': 'v1.0',
        ...
        if (me.strMienGiamId == "") {
            obj_list.action = 'TKGG_KLGD/ThemMoiMienGiam';
            obj_list.strId = '';
