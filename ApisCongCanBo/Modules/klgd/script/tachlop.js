...
tachlop.prototype = {
    ...
    ThucHienTach: function (strTachTheoSinhVien_Tiet) {
        ...
        var strKieuHoc = dt[0].KIEUHOC;
        const array_LoaiLopTachTheoSV = [5, 6, 4]; 
        if (strTachTheoSinhVien_Tiet == "") {
        ...
        var obj_list = {
            'action': 'TKGG_KLGD/ThucHienTachTaoLop',//Hàm cũ ThucHienTach
            'versionAPI': 'v1.0',
            ...
            'strHeDaoTaoId': edu.util.getValById('drpHeDaoTao'),            
            'strCoSoDaoTaoId': edu.util.getValById('drpCoSoDaoTao'),
            'strPhanCongId': me.strPhanCongId, 
    ...
    getList_tblLopHocPhan: function () {
        ...
        var strHocKy = edu.util.getValById('drpSchoolYear') + "_" + edu.util.getValById('drpHocKy');
        var obj_list = {
            'action': 'TKGG_KLGD/GetDanhSachLopHPPhucVuTach',
            'versionAPI': 'v1.0',
            'strHocKy': strHocKy,
            'strBoMonId': edu.util.getValById('drpBoMon'),
            'strDotHoc': edu.util.getValById('drpDotHoc'),
    ...
    genTable_tblLopDaTach: function (data, iPager) {
        var me = this;
        //$("#lblPhongThi_Tong").html(iPager);
        var dulieuLopHocPhan = edu.util.objGetDataInData(me.strPhanCongId, me.dtLopHocPhan, "PHANCONGID");
        ...
        $("#lblTongLyThuyet").text("(" + dulieuLopHocPhan[0].LT + ")");
        $("#lblTongBaiTap").text("(" + dulieuLopHocPhan[0].BT + ")");
        $("#lblTongThaoLuan").text("(" + dulieuLopHocPhan[0].TL + ")");
        $("#lblTongThiNghiem").text("(" + dulieuLopHocPhan[0].TN + ")");
        $("#lblTongThucHanh").text("(" + dulieuLopHocPhan[0].TH + ")");
