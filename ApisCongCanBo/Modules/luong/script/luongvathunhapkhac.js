...
LuongDuocNhanKhac.prototype = {
    ...
    genTable_DuocNhanKhac: function (data, iPager) {
        ...
        $("#tblDuocNhanKhac tfoot td:eq(6)").attr("style", "text-align: right");
        $("#tblDuocNhanKhac tfoot td:eq(7)").attr("style", "text-align: right");
        me.dLuong = 0;
        me.dThue = 0;
        if (data.length > 0) {
    ...
    genTable_LuongThuNhap: function (data, iPager) {
        ...
        $("#tblLuongThuNhap tfoot td:eq(8)").attr("style", "text-align: right");
        $("#tblLuongThuNhap tfoot td:eq(9)").attr("style", "text-align: right");
        if (data.length > 0) {
            me.dLuong += edu.util.returnZero(data[0].TONGLUONG_THUNHAPKHAC);
            me.dThue += edu.util.returnZero(data[0].TONGTHUE_TNCN);
        }
