...
HuongDanSauDaiHoc.prototype = {
    ...
    init: function () {
        ...
        $(".btnClose").click(function () {
            if (edu.util.checkValue(edu.util.getValById("txtHDGD_TenDetai")) || edu.util.checkValue(edu.util.getValById("txtHDGD_TenHocVien"))) {
    ...
    rewrite: function () {
        ...
        var me = main_doc.HuongDanSauDaiHoc;
        //
        $("#myModalLabel_HDSDH").html('.. <i class="fa fa-pencil"></i> Kê khai hướng dẫn sau đại học');
        me.strHDGD_Id = "";
        me.arrSinhVien_Id = [];
    ...
    viewEdit_HDGD: function (data) {
        ...
        $("#myModalLabel_HDSDH").html('<i class="fa fa-edit"></i> Chỉnh sửa hướng dẫn sau đại học');
    },
    /*------------------------------------------
    ...
    genTable_ThanhVien: function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            me.arrGiangVien_HD_Id.push(data[i].GIANGVIEN_ID);
            var html = "";
    ...
    save_SinhVien: function (strNhanSu_Id, strHDGD_Id) {
        var me = main_doc.HuongDanSauDaiHoc;
