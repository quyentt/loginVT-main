...
DeTai.prototype = {
    ...
    init: function () {
        ...
        $("#tblDeTai").delegate(".btnEdit", "click", function () {
            ...
            if (edu.util.checkValue(strId)) {
                ...
                edu.system.getList_RangBuoc("NCKH_QUANLYDETAI", strId);
            }
            else {
       ...
       -------------------------------------------*/
        ...
        --Order: 
        -------------------------------------------*/
        $("#dropDeTai_DanhMuc").on("select2:select", function () {
            var obj = edu.util.objGetOneDataInData($("#dropDeTai_DanhMuc").val(), me.dtDanhMucDT, "ID");
            me.viewEdit_DanhMuc(obj);
        });
    ...
    page_load: function () {
        ...
        me.toggle_form();
        edu.system.loadToCombo_DanhMucDuLieu(constant.setting.CATOR.NCKH.LVNC, "dropDeTai_LinhVuc,dropSearchModal_DeTai_LinhVuc");
        edu.system.loadToCombo_DanhMucDuLieu("NCKH.SPUD", "dropDeTai_SP_Loai");
        edu.system.loadToCombo_DanhMucDuLieu("NCKH.CAPQUANLY", "dropDeTai_CapQuanLy");
        ...
        edu.system.loadToCombo_DanhMucDuLieu(constant.setting.CATOR.NCKH.PLDT, "dropDeTai_PhanLoai");
        var obj = {
        ...
        edu.system.switchLoaiKhac("dropDeTai_PhanLoai", "txtDeTai_PhanLoai_Khac", true);
        edu.system.switchLoaiKhac("dropDeTai_CapQuanLy", "txtDeTai_CapQuanLy_Khac", true);
        me.getList_DMDeTai();
    },
    ...
    toggle_form: function () {
        ...
        $("#txtDeTai_Ten").focus();
        setTimeout(function () {
            me.setCheckChange("zone_input_detai");
        }, 1000);
    },
    ...
    rewrite: function () {
        //reset id
        var me = this;
        $("#myModalLabel_DeTai").html('.. <i class="fa fa-pencil"></i> Kê khai đề tài');
        me.bcheckTimKiem = false;
        me.strDeTai_Id = "";
        me.arrNhanSu_Id = [];
        me.arrDVHT_Id = [];
        var arrId = ["txtDeTai_TenTiengViet", "txtDeTai_Ma", "txtDeTai_TenTiengAnh", "txtDeTai_ToChucCoDeTai", "dropDeTai_PhanLoai", "txtDeTai_DonViThucHien", "txtDeTai_PhanLoai_Khac", "txtDeTai_CapQuanLy_Khac",
            "dropDeTai_CapQuanLy", "dropDeTai_LinhVuc", "txtDeTai_TuThang", "txtDeTai_DenThang", "dropDeTai_SanPhamUD", "dropDeTai_DanhMuc",
            ...
            "txtDeTai_DVHT_Ten", "dropDeTai_KinhPhi_DonViTienTe", "txtDeTai_KinhPhi_SoTien", "dropDeTai_KinhPhi_Nguon", "txtDeTai_TDDT_TienConLai", "txtDeTai_TDDT_TienThanhToan", "txtDeTai_TDDT_ThoiGian", "txtDeTai_TongSoTacGia", "txtDeTai_SoTacGiaTrongTruong"];
        ...
        edu.util.viewValById("txtDeTai_PhanLoai_Khac", "");
        edu.util.viewValById("txtDeTai_CapQuanLy_Khac", "");
        edu.util.viewValById("txtDeTai_NgoaiTruongKhac", "");
    ...
    genTable_DeTai: function (data, iPager) {
        ...
        if (me.strDeTai_Id != '') {
            $("#" + jsonForm.strTable_Id + ' tr[id="' + me.strDeTai_Id + '"]').trigger("click");
        }
        /*III. Callback*/
    },
    ...
    save_DeTai: function () {
        ...
        var obj_save = {
            ...
            'strId': "",
            'strNCKH_TinhDiem_KeHoach_Id': edu.util.getValById('dropSearch_NamDanhGia_DT'),
            'strPhanLoaiDeTai_Khac': edu.util.getValById("txtDeTai_PhanLoai_Khac"),
            'strPhanLoaiDeTai_Id': edu.util.getValById("dropDeTai_PhanLoai"),
            'strNCKH_SP_DanhMucDeTai_Id': edu.util.getValById('dropDeTai_DanhMuc'),
            ...
            'strDonViThucHienDeTai': edu.util.getValById("txtDeTai_DonViThucHien"),
            ...
            'dSoTacGiaTrongTruong_n': edu.util.getValById("txtDeTai_SoTacGiaTrongTruong"),
            'strChucNang_Id': edu.system.strChucNang_Id,
            'iTinhTrang': 1,
            'strNhaTaiTro': "",
            'strDoiTac_Id': "",
            ...
            'strThuTu_ThanhVien': "",
            'strTyLeThamGia': "",
            'strDanhSachCacThanhVienNgoai': edu.util.getValById("txtDeTai_NgoaiTruongKhac"),
        };
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
    ...
    viewEdit_DeTai: function (data) {
        ...
        edu.util.viewValById("txtDeTai_DonViThucHien", dtDeTai.DONVITHUCHIENDETAI);
        edu.util.viewValById("dropDeTai_PhanLoai", dtDeTai.PHANLOAIDETAI_ID);
        $('#dropDeTai_PhanLoai').trigger({ type: 'select2:select' });
        edu.util.viewValById("txtDeTai_PhanLoai_Khac", dtDeTai.PHANLOAIDETAI_KHAC);
        edu.util.viewValById("dropDeTai_CapQuanLy", dtDeTai.CAPQUANLY_ID);
        $('#dropDeTai_CapQuanLy').trigger({ type: 'select2:select' });
        edu.util.viewValById("txtDeTai_CapQuanLy_Khac", dtDeTai.CAPQUANLY_KHAC);
        ...
        edu.util.viewValById("txtDeTai_SoTacGiaTrongTruong", dtDeTai.SOTACGIATRONGTRUONG_N);
        edu.util.viewValById("txtDeTai_NgoaiTruongKhac", dtDeTai.DANHSACHCACTHANHVIENNGOAI);
    },
    viewEdit_DanhMuc: function (dtDeTai) {
        var me = this;
        //View - Thong tin
    ...
    /*------------------------------------------
    --Discription: [3] AccessDB sản phẩm ứng dụng
    --ULR:  Modules
    -------------------------------------------*/
    ...
    /*------------------------------------------
    --Discription: [4] GenHTML Bộ lọc nhân sự
    --ULR:  Modules
    -------------------------------------------*/
    ...
    genComBo_CCTC: function (data) {
        var obj = {
            ...
            renderPlace: ["dropSearchModal_DeTai_DonVi"],
            type: "",
            title: "Chọn đơn vị"
        };
        edu.system.loadToCombo_data(obj);
    ...
    /*------------------------------------------
    --Discription: [4] GenHTML Năm đánh giá
    --ULR:  Modules
    -------------------------------------------*/
    ...
    --ULR:  Modules
    -------------------------------------------*/
    getList_DMDeTai: function (data, iPager) {
        var me = this;
        var obj_list = {
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.dtDanhMucDT = dtResult;
                    me.genCombo_DMDeTai(dtResult);
                }
                else {
                    edu.system.alert(obj_list.action + ": " + data.Message, "w");
                }
    ...
    genCombo_DMDeTai: function (data) {
        var me = this;
        var obj = {
            data: data,
            renderInfor: {
            ...
            renderPlace: ["dropDeTai_DanhMuc"],
            title: "Chọn danh mục đề tài"
        };
        edu.system.loadToCombo_data(obj);
    },
};