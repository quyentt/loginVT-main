...
NhapDiem.prototype = {
    ...
    init: function () {
        ...
        $("#btnBaoCao_GiaoDien").click(function () {
            edu.system.reportAllTable_Input("tblNhapDiem");
        });
    ...
    tinh_Diem: function (point) {
        ...
        var aData = edu.util.objGetDataInData(strNguoiHoc_Id, me.dtNguoiHoc, "ID")[0];
