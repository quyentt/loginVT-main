/**
 * ============================================
 * DASHBOARD LÃNH ĐẠO KHOA - BACKEND LOGIC
...
function DashboardKhoa() {
    ...
    this.kpiData = [
        ...
        },
        {
            ...
            trend: 'up',
            trendValue: '+8.2%',
            subtext: '85% đạt chỉ tiêu (800 SV)',
            color: 'blue',
            tooltip: 'Dữ liệu cập nhật đến đợt tuyển sinh Đợt 2 - 2025',
            updateType: 'Theo đợt'
        },
        {
            id: 'kpi3',
            ...
            trend: 'up',
            trendValue: '+3.2%',
            subtext: '550/700 SV dự kiến TN',
            color: 'purple',
            tooltip: 'Chỉ số vàng của Khoa - Dữ liệu cập nhật theo năm học',
            updateType: 'Theo năm'
        },
        {
            id: 'kpi4',
            ...
            trend: 'down',
            trendValue: '-1.5%',
            subtext: '201/2,450 SV bị cảnh báo',
            color: 'orange',
     ...
     */
    this.majorData = [
        { name: 'Công nghệ thông tin', students: 850, gpa: 3.5, passRate: 95, status: 'Tốt', color: 'good', quality: 'Chất lượng tốt' },
        { name: 'Công nghệ thông tin Việt Nhật', students: 420, gpa: 3.2, passRate: 90, status: 'Tốt', color: 'good', quality: 'Chất lượng tốt' },
        { name: 'An toàn thông tin', students: 380, gpa: 3.1, passRate: 93, status: 'Tốt', color: 'good', quality: 'Chất lượng tốt' },
        { name: 'Tài năng Khoa học máy tính', students: 350, gpa: 2.9, passRate: 85, status: 'Khá', color: 'medium', quality: 'Phân hóa mạnh' },
        { name: 'Trí tuệ nhân tạo', students: 280, gpa: 2.8, passRate: 80, status: 'Khá', color: 'medium', quality: 'Chất lượng chưa cao' }
    ];

    /**
     * Dữ liệu biểu đồ GPA / Tỷ lệ đỗ theo ngành
     */
    this.gpaPassRateData = {
        labels: this.majorData.map(m => m.name),
        datasets: [
            {
                label: 'GPA TB tháng 4',
                type: 'bar',
                data: this.majorData.map(m => m.gpa),
            ...
            },
            {
                label: 'Tỷ lệ đỗ',
                type: 'line',
                data: this.majorData.map(m => m.passRate),
    ...
    /**
     * Dữ liệu biểu đồ quy mô sinh viên theo năm
     */
    this.studentFlowData = {
        ...
        datasets: [
            ...
            {
                label: 'SV đang học',
                data: [1200, 1400, 1500, 2000, 2300, 2500, 3400],
    ...
    /**
     * Dữ liệu rủi ro theo ngành/CTĐT
     */
    this.riskData = [
        {
     ...
     */
    this.init = function() {
        console.log('🚀 Dashboard Khoa: Initializing...');
        ...
        console.log('✅ Dashboard Khoa: Initialized successfully');
    };
    ...
    this.renderQuickStats = function() {
        ...
        container.innerHTML = `
            <div class="quick-stat-item">
                <span class="quick-stat-label">Tổng số ngành:</span>
                <span class="quick-stat-value">8</span>
            </div>
            <div class="quick-stat-item">
                <span class="quick-stat-label">Tỷ lệ có việc làm:</span>
                <span class="quick-stat-value">92%</span>
            </div>
            <div class="quick-stat-item">
                <span class="quick-stat-label">Số lượng GV TS:</span>
                <span class="quick-stat-value">18/45</span>
            </div>
            <div class="quick-stat-item">
                <span class="quick-stat-label">Điểm đánh giá khoa:</span>
                <span class="quick-stat-value">4.2/5</span>
            </div>
        `;
    };
    ...
    this.showChartFallback = function() {
        const chartIds = ['studentByMajorChart', 'academicResultChart', 'tuitionChart'];
        chartIds.forEach(id => {
    ...
    /**
     * Biểu đồ GPA / Tỷ lệ đỗ theo ngành
     */
    this.initGPAPassRateChart = function() {
        const canvas = document.getElementById('studentByMajorChart');
        if (!canvas) return;
                ...
                tooltips: {
                    ...
                    callbacks: {
                        ...
                        afterBody: function(tooltipItems, data) {
                            ...
                            var majorData = main_doc.DashboardKhoa.majorData[index];
                            return [
                                '',
                                '📊 Đánh giá: ' + majorData.quality,
                                '👥 Sinh viên: ' + majorData.students
                            ];
                        }
                    }
                },
    ...
    /**
     * Biểu đồ quy mô sinh viên theo năm
     */
    this.initAcademicResultChart = function() {
        const canvas = document.getElementById('academicResultChart');
        if (!canvas) return;
