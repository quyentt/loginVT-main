...
PhanCap.prototype = {
    ...
    init: function () {
        ...
        $("#tblPhanCap_LanhDaoDG").delegate(".btnEdit", "click", function () {
            var strId = this.id;
            ...
            if (edu.util.checkValue(strId)) {
                ...
                edu.util.setOne_BgRow(strId, "tblPhanCap_LanhDaoDG");
            }
            else {
    ...
    getList_LanhDaoDG: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'NS_PLDG_LTT_PhanCap/LayDanhSachLanhDao',
            
            'strNhanSu_DGPL_LTT_KH_Id': edu.util.getValById("dropSearch_PhanCap_KeHoach")
        };
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    edu.system.alert("NS_PLDG_LTT_PhanCap/LayDanhSach: " + data.Message, "w");
                }
                
            },
            error: function (er) {
                edu.system.alert("NS_PLDG_LTT_PhanCap/LayDanhSach (er): " + JSON.stringify(er), "w");
    ...
    getList_NhanVienDG: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'NS_PLDG_LTT_PhanCap/LayDanhSachNhanVien',
    ...
    save_PhanCap: function () {
        ...
        //--Edit
        var obj_save = {
            'action': 'NS_PLDG_LTT_PhanCap/ThemMoi',
            

            'strId': "",
            'strNhanSu_DGPL_ltt_KH_Id': edu.util.getValById("dropPhanCap_KeHoach"),
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    edu.system.alert("NS_PLDG_LTT_PhanCap/ThemMoi: " + data.Message);
                }
                
            },
            error: function (er) {
                edu.system.alert("NS_PLDG_LTT_PhanCap/ThemMoi (er): " + JSON.stringify(er), "w");
    ...
    delete_PhanCap: function (strId) {
        ...
        var obj = {};
        var obj_delete = {
            'action': 'NS_PLDG_LTT_PhanCap/Xoa',
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    obj = {
                        content: "NS_PLDG_LTT_PhanCap/Xoa: " + data.Message,
                        code: ""
                    };
                    edu.system.afterComfirm(obj);
                }
            ...
            error: function (er) {
                var obj = {
                    content: "NS_PLDG_LTT_PhanCap/Xoa (er): " + JSON.stringify(er),
                    code: "w"
                };
                edu.system.afterComfirm(obj);
    ...
    /*------------------------------------------
    --Discription: [2] GenHTML add NhanSu to DTDG
    --Task: 
    -------------------------------------------*/
    ...
    /*------------------------------------------
    --Discription: [2] GenHTML add NhanSu to DTDDG
    --Task: 
    -------------------------------------------*/
