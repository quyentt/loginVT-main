        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    edu.system.alert("NS_CoCauToChuc/ThemMoi: " + data.Message);
                }                
            },
            error: function (er) {
                edu.system.alert("NS_CoCauToChuc/ThemMoi (er): " + JSON.stringify(er), "w");                
            },
            type: 'POST',            
            contentType: true,            
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    edu.system.alert("NS_CoCauToChuc/CapNhat: " + data.Message);
                }                
            },
            error: function (er) {
                edu.system.alert("NS_CoCauToChuc/CapNhat (er): " + JSON.stringify(er), "w");                
            },
            type: 'POST',            
            contentType: true,            
            action: obj_save.action,
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    edu.system.alert("NS_CoCauToChuc/Xoa: " + data.Message);
                }                
            },
            error: function (er) {
                edu.system.alert("NS_CoCauToChuc/Xoa (er): " + JSON.stringify(er), "w");                
            },
            type: 'POST',
