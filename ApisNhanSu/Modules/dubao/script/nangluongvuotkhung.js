...
----------------------------------------------*/
function NangLuongVuotKhung() { };
NangLuongVuotKhung.prototype = {
    dtReportTemp: [],
    ...
    init: function () {
        ...
        --Order: 
        -------------------------------------------*/
        $("#dropSearchNLVK_CoCauToChuc").on("select2:select", function () {
    ...
    page_load: function () {
        ...
        setTimeout(function () {
            var obj = {
                strMaBangDanhMuc: constant.setting.CATOR.SYS.RP.NLVK,
                strTenCotSapXep: "",
                iTrangThai: 1
            };
    ...
    /*------------------------------------------
    --Discription: [1] AcessDB NangLuongVuotKhung
    -------------------------------------------*/
    getList_NLTruocThoiHan: function () {
        var me = this;
        var strDonViBoPhan_Id = "";
        var strCoCauToChuc = $("#dropSearchNLVK_CoCauToChuc").val();
        var strBoMon = $("#dropSearchNLVK_BoMon").val();
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.genTable_NLTruocThoiHan(dtResult, iPager);
                }
                else {
                    edu.system.alert("NS_DuBao/NangLuongVuotKhung: " + data.Message, "w");
                }
                
            },
            error: function (er) {
                edu.system.alert("NS_DuBao/NangLuongVuotKhung (er): " + JSON.stringify(er), "w");
    ...
    -------------------------------------------*/
    genTable_NLTruocThoiHan: function (data, iPager) {
        var me = this;

        var jsonForm = {
            strTable_Id: "tbldataNLVK",
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.NangLuongVuotKhung.getList_NLTruocThoiHan()",
                iDataRow: iPager
            },
            bHiddenHeader: true,
            colPos: {
            ...
            aoColumns: [
                ...
                , {
                    "mDataProp": "BACLUONGCUOICUANGACH"
                }
                , {
                    "mDataProp": "HESOLUONGBACCUOICUANGACH"
                }
                , {
                    "mDataProp": "LAYNGAYHUONGLUONGVUOTKHUNG"//thoi diem duoc xep 
                }
                , {
                    "mDataProp": "PHANTRAMVUOTKHUNGDAHUONG"//
                }
                , {
                    "mDataProp": "NGAYHUONGVUOTKHUNGTIEP_HIENTAI"
                }
                , {
                    "mDataProp": "PHANTRAMVUOTKHUNGTIEP"
                }
                , {
                    "mDataProp": "NGAYHUONGVUOTKHUNGTIEP"
                }
                , {
                    "mDataProp": "SOTHANGDUOCHUONGTINHTU"
                }
            ]
        };
    ...
    processData_CoCauToChuc: function (data) {
        var me = main_doc.NangLuongVuotKhung;
        var dtParents = [];
        var dtChilds = [];
    ...
    genCombo_CCTC_Parents: function (data) {
        var obj = {
            ...
            renderPlace: ["dropSearchNLVK_CoCauToChuc"],
            type: "",
    ...
    genCombo_CCTC_Childs: function (data) {
        var obj = {
            ...
            renderPlace: ["dropSearchNLVK_BoMon"],
            type: "",
            title: "Chọn bộ môn"
        };
        edu.system.loadToCombo_data(obj);
    ...
    cbGenLink_InHoSo: function (data) {
        ...
        $("#zoneReport_NLVK").html(html_link);
    },
};