...
----------------------------------------------*/
function NangLuongTruocHan() { };
NangLuongTruocHan.prototype = {
    dtReportTemp: [],
    ...
    init: function () {
        ...
        --Order: 
        -------------------------------------------*/
        $("#dropSearchNLTTH_CoCauToChuc").on("select2:select", function () {
    ...
    page_load: function () {
        ...
        setTimeout(function () {
            var obj = {
                strMaBangDanhMuc: constant.setting.CATOR.SYS.RP.NLTH,
                strTenCotSapXep: "",
                iTrangThai: 1
            };
    ...
    getList_NLTruocThoiHan: function () {
        ...
        var strCoCauToChuc = $("#dropSearchNLTH_CoCauToChuc").val();
        var strBoMon = $("#dropSearchNLTH_BoMon").val();
    ...
    genTable_NLTruocThoiHan: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            aoColumns: [
                ...
                , {
                    "mDataProp": "SOTHANGNANGLUONGTRUOCHAN"
                }
                , {
                    "mDataProp": "NGAYHUONGLUONG_TIEPTHEO"
                }
                , {
                    "mDataProp": "THANHTICHDUOCGHINHANTRUOCHAN"
                }
            ]
        };
    ...
    processData_CoCauToChuc: function (data) {
        var me = main_doc.NangLuongTruocHan;
        var dtParents = [];
        var dtChilds = [];
    ...
    genCombo_CCTC_Parents: function (data) {
        var obj = {
            ...
            renderPlace: ["dropSearchNLTH_CoCauToChuc"],
            type: "",
    ...
    genCombo_CCTC_Childs: function (data) {
        var obj = {
            ...
            renderPlace: ["dropSearchNLTH_BoMon"],
            type: "",
            title: "Chọn bộ môn"
        };
        edu.system.loadToCombo_data(obj);
    ...
    cbGenLink_InHoSo: function (data) {
        ...
        $("#zoneReport_NLTH").html(html_link);
    },
};