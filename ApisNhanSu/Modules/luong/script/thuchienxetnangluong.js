...
--Note:
----------------------------------------------*/
function XetNangLuong() { };
XetNangLuong.prototype = {
    arrHeadDiem_Id: [],
    ...
    init: function () {
        ...
        $("#btnViewLuong").click(function () {
            var strQuyDinhLuong = edu.util.getValById("dropSearch_KeHoachXetLuong");
            if (!edu.util.checkValue(strQuyDinhLuong)) {
        ...
        edu.system.getList_MauImport("zonebtnBaoCao_XetNangLuong", function (addKeyValue) {
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.genCombo_KeHoachXetNangLuong(dtReRult, data.Pager);
                }
                else {
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genCombo_KeHoachXetNangLuong: function (data) {
        var me = this;
        var obj = {
            data: data,
            renderInfor: {
                id: "ID",
                parentId: "",
                name: "LOAIXETLUONG_TEN",
                code: "MA",
                order: ""
            },
            renderPlace: ["dropSearch_KeHoachXetLuong"],
            title: "Chọn ké hoạch nâng lương"
        };
    ...
    getList_DieuKienXetNangLuong: function (strDanhSach_Id) {
        ...
        var obj_list = {
            ...
            'strNhanSu_KeHoachXetLuong_Id': edu.util.getValById("dropSearch_KeHoachXetLuong"),
            'strNguoiThucHien_Id': "",
        };
        //
        edu.system.makeRequest({
    ...
    --Discription: [1] AcessDB GetList_DeTai
    -------------------------------------------*/
    XetNangLuong: function () {
        var me = this;
        var obj_notify = {};
        //--Edit
        var obj_save = {
            'action': 'L_XetLuong_CauTruc/LayDSDuLieuXetLuong',
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    edu.system.alert("Thực hiện xét nâng lương thành công");
                }
                else {
                    obj_notify = {
                        type: "w",
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    var dtXetNangLuong = dtReRult.rsDuLieuXetLuong;
                    me.genTable_XetNangLuong(dtNhanSu);
                    me.genData_XetNangLuong(dtXetNangLuong);
                }
                else {
                    edu.system.alert(obj_list + " : " + data.Message, "s");
                }
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genTable_XetNangLuong: function (data, iPager) {
        var me = this;
        var jsonForm = {
            strTable_Id: "tblKhoiTao_NhanSu",
            aaData: data,
    ...
    genData_XetNangLuong: function (data) {
