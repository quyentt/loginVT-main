...
CauTrucBangLuong.prototype = {
    ...
    init: function () {
        ...
        edu.system.loadToCombo_DanhMucDuLieu("NHANSU.LUONG.DONVITINH", "dropBL_DonViTinh");
    ...
    toggle_edit: function (strDanhSach_Id) {
        ...
        edu.util.viewValById("dropBL_LamTron", -1);
        edu.util.viewValById("dropBL_ChiLayPhanNguyen", 0);
        edu.util.viewValById("dropBL_DonViTinh", "");
        edu.util.viewValById("dropBL_ThanhPhanCuoi", 0);
    ...
    --ULR:  Modules
    -------------------------------------------*/
    getList_QuyDinhLuong: function (strDeTai_Id) {
        var me = this;
        //--Edit
        var obj_list = {
    ...
    save_CauTrucBangLuong: function () {
        ...
        //--Edit
        var obj_save = {
            'action': 'L_CauTrucBangLuong/ThemMoi',
            ...
            'dSoChuSoLamTron': edu.util.getValById('dropBL_LamTron'),
            'dChiLayPhanSoNguyen': edu.util.getValById('dropBL_ChiLayPhanNguyen'),
            'strDonViTinh_Id': edu.util.getValById('dropBL_DonViTinh'),
            'dLaThanhPhanCuoi': edu.util.getValById('dropBL_ThanhPhanCuoi'),
        };
        if (edu.util.checkValue(me.strCauTrucBangLuong_Id)) {
            obj_save.action = 'L_CauTrucBangLuong/CapNhat';
    ...
    getList_CauTrucBangLuong: function (strDanhSach_Id) {
        ...
        //--Edit
        var obj_list = {
            'action': 'L_CauTrucBangLuong/LayDanhSach',
    ...
    viewForm_CauTrucBangLuong: function (strId) {
        ...
        edu.util.viewValById("dropBL_LamTron", data.SOCHUSOLAMTRON);
        edu.util.viewValById("dropBL_ChiLayPhanNguyen", data.CHILAYPHANSONGUYEN);
        edu.util.viewValById("dropBL_DonViTinh", data.DONVITINH_ID);
        edu.util.viewValById("dropBL_ThanhPhanCuoi", data.LATHANHPHANCUOI);
    ...
    getList_CauTruc_TuKhoa: function (strDeTai_Id) {
        ...
        //--Edit
        var obj_list = {
            'action': 'L_CauTrucBangLuong_TuKhoa/LayDanhSach',
