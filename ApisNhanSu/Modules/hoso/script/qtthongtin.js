...
ThongTin.prototype = {
    ...
    init: function () {
        ...
        $("#zoneTab").delegate('.tabhoatdong', 'click', function (e) {
            ...
            edu.util.viewValById("dropHoatDong", strId);
            me.getList_ThongTin();
       ...
       -------------------------------------------*/
        ...
        $("#dropHoatDong").on("select2:select", function () {
            me.strHoatDong_Id = $("#dropHoatDong").val();
            me.getList_TuNhapHoSo();
        });
        ...
        $("#tblCapNhat_NhanSu").delegate('.btnDetail', 'click', function (e) {
            var strId = this.id;
            me.strNguoiDung_Id = edu.util.cutPrefixId(/view_/g, strId);
            edu.util.setOne_BgRow(strId, "tblCapNhat_NhanSu");
            $("#zoneEdit1").slideDown();
            me.getList_ThongTin();
            $("#zoneEdit").slideUp();
        });
            ...
            success: function (data) {
                if (data.Success) {
                    ...
                    for (var i = 0; i < me.dtTuNhapHoSo.length; i++) {
                        me.save_TuNhapHoSo(me.dtTuNhapHoSo[i], strThongTin_Id);
                    }
                }
                else {
    ...
    viewEdit_ThongTin: function (data) {
        ...
        me.strHoatDong_Id = data.HOATDONGNHANSU_ID;
    ...
    --ULR:  Modules
    -------------------------------------------*/
    save_TuNhapHoSo: function (aData, strThongTin_Id) {
        var me = this;
        var obj_notify = {};
        if (aData.KIEUDULIEU.toUpperCase() == "FILE") {
            edu.system.saveFiles("m" + aData.ID, aData.ID, "NS_Files");
        }
        //--Edit
        var obj_save = {
            ...
            'strNhanSu_HoSoCanBo_Id': me.strNguoiDung_Id,
            'strHoatDongNhanSu_Id': me.strHoatDong_Id,
            'strNhanSu_HoatDong_TT_Id': strThongTin_Id,
    ...
    getList_TuNhapHoSo: function (strDanhSach_Id) {
        ...
        var obj_list = {
            ...
            'strChucNang_Id': edu.system.strChucNang_Id,
            'strNhanSu_HoSoCanBo_Id': me.strNguoiDung_Id,
            'strNhanSu_HoatDong_TT_Id': me.strThongTin_Id,
            'strHoatDongNhanSu_Id': edu.util.getValById("dropHoatDong"),
            'strNguoiThucHien_Id': edu.system.userId,
        };
        //
            ...
            data.forEach(aData => {
                if (aData.KIEUDULIEU) {
                    ...
                    switch (aData.KIEUDULIEU.toUpperCase()) {
                        ...
                        case "FILE": edu.system.viewFiles("m" + aData.ID, aData.ID, "NS_Files"); break;
                    }
                }
            });
        }, 1000);
