...
TangThem.prototype = {
    ...
    init: function () {
        ...
        $("#btnSave_TangThem").click(function () {
            me.save_TangThem();
        });
        ...
        $("#chkSelectAll").on("click", function () {
            edu.util.checkedAll_BgRow(this, { table_id: "tblTangThem" });
        });
    },
    popup: function () {
        //show
    ...
    --ULR:  Modules
    -------------------------------------------*/
    save_TangThem: function () {
        var me = this;
        var obj_notify = {};
        //--Edit
        var obj_save = {
            'action': 'NS_HeSo_TangThem/ThemMoi',
            ...
            'dHeSoQuyDoiTangThem': edu.util.getValById('txtHeSo'),
    ...
    getList_TangThem: function (strDanhSach_Id) {
        var me = this;
        //--Edit
        var obj_list = {
            'action': 'NS_HeSo_TangThem/LayDanhSach',
            ...
            'strMoHinhHoc_Id': edu.util.getValById('dropSearch_MoHinhHoc'),
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.dtTangThem = dtReRult;
                    me.genTable_TangThem(dtReRult, data.Pager);
                }
                else {
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genTable_TangThem: function (data, iPager) {
        $("#lblTangThem_Tong").html(iPager);
        var jsonForm = {
            strTable_Id: "tblTangThem",
            aaData: data,
            bPaginate: {
            ...
            aoColumns: [
                ...
                {
                    "mDataProp": "HESOQUYDOITANGTHEM"
                },
                {
                    "mDataProp": "MOHINHHOC_TEN"
                },
                {
    ...
    viewForm_TangThem: function (strId) {
        var me = this;
        //call popup --Edit
        var data = edu.util.objGetDataInData(strId, me.dtTangThem, "ID")[0];
        me.popup();
        //view data --Edit
        ...
        edu.util.viewValById("txtHeSo", data.HESOQUYDOITANGTHEM);
        edu.util.viewValById("dropMoHinhHoc", data.MOHINHHOC_ID);
        me.strTangThem_Id = data.ID;
    },
}