...
--Note:
----------------------------------------------*/
function DiemHocPhan() { };
DiemHocPhan.prototype = {
    objHangDoi: {},
    strPhamViMa: '',
    ...
    init: function () {
        ...
        //    me.getList_KetQua();
        //});
        //$("#tblTaskBar_DiemHocPhan").delegate("#btnXemDanhSach", "click", function () {
        //    me.getList_KetQua();
        //});
        ...
        edu.system.getList_MauImport("zonebtnBaoCao_DTB", function (addKeyValue) {
            ...
            addKeyValue("strDaoTao_ThoiGianDaoTao_Id", edu.util.getValCombo('dropPhanViTongHop_' + edu.DiemHocPhan.strPhamViMa));
    ...
    ----------------------------------------------*/
    TaoHangDoi_DiemHocPhan_TuDong: function () {
        var me = this;
        var obj_notify = {};
        //--Edit
        var obj_save = {
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    var obj = {
                        content: "TC_HangDoi.TaoHangDoi_DiemHocPhan_TuDong: " + data.Message,
                        code: "w",
                    }
                    edu.system.afterComfirm(obj);
                }
            ...
            error: function (er) {
                ...
                var obj = {
                    content: "TC_HangDoi.TaoHangDoi_DiemHocPhan_TuDong (er): " + JSON.stringify(er),
                    code: "w",
                }
                edu.system.afterComfirm(obj);
            },
    ...
    getList_KetQua: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'D_ThongKe/LayDSDiem_ThongKe_DiemHP',
            'type': 'GET',
    ...
    save_TongHop: function () {
        ...
        var obj_save = {
            ...
            'strThoiGian_Id': edu.util.getValById('dropPhanViTongHop_NHIEUKY'),
            'strLoaiDanhSach_Id': edu.util.getValById('dropLoaiDanhSach'),
    ...
    delete_TongHop: function (Ids) {
        ...
        //--Edit
        var obj_delete = {
            'action': 'D_ThongKe/Xoa_Diem_ThongKe_DiemHP',
            'type': 'POST',
            'strBangDuLieu': edu.util.getValById('txtSearch_BangDuLieu'),
            'strNguoiThucHien_Id': edu.system.userId,
        };
