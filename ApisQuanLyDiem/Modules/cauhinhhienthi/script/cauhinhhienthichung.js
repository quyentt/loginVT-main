...
--Note:
----------------------------------------------*/
function CauHinhHienThiChung() { };
CauHinhHienThiChung.prototype = {
    init: function () {
        var me = this;
        /*------------------------------------------
    ...
    save_CauHinhHienThiCot: function (point) {
        ...
        var obj_save = {
            'action': 'D_CauHinhCotHienThi_C/ThemMoi',
            ...
            'strKichThuocFontChu': point.cells[4].getElementsByTagName('input')[0].value,
            'strCanLe': strCanLe,
            'strChuDam': strChuDam,
        ...
        if (strRowId.length == 32) {
            obj_save.action = 'D_CauHinhCotHienThi_C/CapNhat';
    ...
    getList_CauHinhHienThiCot: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'D_CauHinhCotHienThi_C/LayDanhSach',
            'strTuKhoa': '',
            'strChucNang_Id': edu.util.getValById("dropSearchChucNang"),
            'strNguoiDung_Id': '',
            'strNguoiTao_Id': '',
    ...
    delete_CauHinhHienThiCot: function (strId) {
        ...
        var obj = {};
        var obj_delete = {
            'action': 'D_CauHinhCotHienThi_C/Xoa',
            'strNguoiThucHien_Id': edu.system.userId,
            'strId': strId
        };
        //default
    ...
    genTable_CauHinhHienThiCot: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            bPaginate: {
                strFuntionName: "main_doc.CauHinhHienThiChung.getList_CauHinhHienThiCot()",
                iDataRow: iPager
            },
            colPos: {
                center: [0, 1, 6, 8, 9, 10, 11, 12]
            },
            aoColumns: [
                {
                    "mData": "THUTU",
                    "mRender": function (now, aData) {
                        return '<input type="hidden" id="txtThuTu' + aData.ID + '" class="form-control"/>' + (now + 1);
                    }
                },
                {
                    "mData": "MACOT",
