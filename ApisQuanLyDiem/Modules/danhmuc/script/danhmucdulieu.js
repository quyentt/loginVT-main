...
DanhMucDuLieu.prototype = {
    ...
    genInputForm_DMDL: function () {
        ...
        for (var i = 0; i < me.dtDanhMucThuocTinh.length; i++) {
            ...
            switch (me.dtDanhMucThuocTinh[i].TENTRUONGDULIEU) {
                case "Ten":
                    modalBody += "<div class='row aps-form-item'><div class='col-sm-3 aps-lable-name'><label style='font-weight:normal'>" + strMoTa + " (*)</label></div>";
        ...
        modalBody += "<div class='row aps-form-item'><div class='col-sm-3 aps-lable-name'><label style='font-weight:normal'>Mô tả</label></div>";
        modalBody += "<div class='col-sm-9 aps-form-input'><input type='text' id='txtMoTa' class='form-control'/></div></div>";
        modalBody += "<div class='clear'></div>";
        modalBody += "<div class='row aps-form-item'><div class='col-sm-3 aps-lable-name'><label style='font-weight:normal'>Dữ liệu cha</label></div>";
