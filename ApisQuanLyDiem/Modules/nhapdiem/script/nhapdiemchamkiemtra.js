...
ChamKiemTra.prototype = {
    ...
    init: function () {
        ...
        -------------------------------------------*/
        me["strLoaiXacNhan"] = "XACNHAN_HOANTHANH_CHAMKIEMTRA";
        me.getList_ThoiGian();
        me.getList_HocPhan();
        me.getList_NhapDiem();
    ...
    getList_NhapDiem: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'TP_ChamKiemTra/LayDSThiChamKTNhapDiem',
            'type': 'GET',
    ...
    save_NhapDiem: function (strId) {
        ...
        var obj_list = {
            'action': 'TP_ChamKiemTra/CapNhatThi_ChamKT_KetQua',
            'type': 'POST',
    ...
    genTable_NhapDiem: function (data, iPager) {
        ...
        edu.system.move_ThroughInTable("tblChamKiemTra")
    ...
    getList_HocPhan: function (strId) {
        ...
        var obj_save = {
            'action': 'XLHV_TP_ChamKT_MH/DSA4CS4iESkgLwIpICwKFQPP',
            'func': 'PKG_THI_PHACH_CHAMKT.LayHocPhanChamKT',
            'iM': edu.system.iM,
    ...
    getList_Diem: function (objNguoiHoc) {
        ...
        var obj_list = {
            'action': 'TP_ChamKiemTra/LayDiemChamKT',
            'type': 'GET',
