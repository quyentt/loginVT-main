...
XacNhan.prototype = {
    ...
    getList_BtnXacNhan: function (strDanhSach_Id) {
        ...
        //--Edit
        var obj_list = {
            'action': 'HB_XacNhanKetQua/LayDSTinhTrangXacNhan',
            'strNguoiDung_Id': edu.system.userId,
            'strHB_QuyHocBong_Id': edu.util.getValById('dropSearch_PhanLoai'),
        };
        //
    ...
    save_XacNhanTN: function (strSanPham_Id, strTinhTrang_Id, strNoiDung) {
        var me = this;
        var obj_save = {
            'action': 'HB_XacNhanKetQua/ThemMoi',
            'strId': "",
    ...
    getList_XacNhanTN: function (strHoSoDuTuyen_Id, strTable_Id, callback) {
        var me = this;
        var obj_save = {
            'action': 'HB_XacNhanKetQua/LayDanhSach',
            'strTuKhoa': "",
