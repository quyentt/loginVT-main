...
XepLoaiHaBac.prototype = {
    ...
    init: function () {
        ...
        edu.system.loadToCombo_DanhMucDuLieu("VANBANG.XEPLOAI", "", "", function (data) { main_doc.XepLoaiHaBac.dtXLHB = data; });
        edu.system.loadToCombo_DanhMucDuLieu("VANBANG.XEPLOAI", "", "", function (data) { main_doc.XepLoaiHaBac.dtXLGH = data; });
