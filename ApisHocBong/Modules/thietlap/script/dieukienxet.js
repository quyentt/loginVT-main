...
DieuKienXet.prototype = {
    ...
    init: function () {
        ...
        edu.system.loadToCombo_DanhMucDuLieu("HOCBONG.XEPLOAI", "dropXepLoai");
        ...
        $("#btnSave_DieuKienXet").click(function (e) {
            if (me.strPhanCapApDung != "" && me.strDieuKienRieng_Id) {
                me.save_DieuKienRieng(me.dtDieuKienRieng.find(e => e.ID === me.strDieuKienRieng_Id).PHANCAPAPDUNG_ID);
                return;
            }
            switch (me.strPhanCapApDung) {
                ...
                case "MOHINHNIENCHE_TINCHI":
                    ...
                    break;
                default: edu.system.alert(me.strPhanCapApDung + " : Không thuộc HSSV, KEHOACHXETTOTNGHIEP, LOPQUANLY, CHUONGTRINH, KHOAHOC, KHOAQUANLY, HEDAOTAO, MOHINHNIENCHE_TINCHI")
            }
        });
        ...
        $('#dropSearch_QuyHocBongRieng').on('select2:select', function (e) {
    ...
    getList_DieuKienChung: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'HB_XetDuyet_DieuKien/LayDanhSach',
    ...
    save_DieuKienChung: function () {
        ...
        //--Edit
        var obj_save = {
            'action': 'HB_XetDuyet_DieuKien/ThemMoi',
            ...
            'dThuTu': edu.util.getValById('txtAAAA'),
            'strNguoiThucHien_Id': edu.system.userId,
        };
        if (obj_save.strId != "") {
            obj_save.action = 'HB_XetDuyet_DieuKien/CapNhat';
        }
        //default
    ...
    delete_DieuKienChung: function (strId) {
        ...
        var obj = {};
        var obj_delete = {
            'action': 'HB_XetDuyet_DieuKien/Xoa',
    ...
    getList_DieuKienRieng: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'HB_XetDuyet_DieuKien_Ad/LayDanhSach',

            'strTuKhoa': edu.util.getValById('txtSearchRieng'),
            'strHB_QuyHocBong_Id': edu.util.getValById('dropSearch_QuyHocBongRieng'),
            ...
            'pageIndex': edu.system.pageIndex_default,
            'pageSize': edu.system.pageSize_default,
            'strXauDieuKien': edu.util.getValById('txtAAAA'),
            'strXepLoai_Id': edu.util.getValById('dropAAAA'),
            'dThuTu': edu.util.getValById('txtAAAA'),
    ...
    save_DieuKienRieng: function (strPhamViApDung_Id) {
        ...
        //--Edit
        var obj_save = {
            'action': 'HB_XetDuyet_DieuKien_Ad/ThemMoi',
        ...
        if (obj_save.strId != "") {
            obj_save.action = 'HB_XetDuyet_DieuKien_Ad/CapNhat';
    ...
    delete_DieuKienRieng: function (strId) {
        ...
        var obj = {};
        var obj_delete = {
            'action': 'HB_XetDuyet_DieuKien_Ad/Xoa',
    ...
    getList_PhanCapApDung: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'HB_PhanCapApDung/LayDanhSach',
            'strPhanLoai_Id': edu.util.getValById('dropSearch_QuyHocBongRieng'),
        };
    ...
    getList_TuKhoa: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'HB_XepLoai_TuKhoa/LayDanhSach',
    ...
    save_TuKhoa: function (strId) {
        ...
        //--Edit
        var obj_save = {
            'action': 'HB_XepLoai_TuKhoa/ThemMoi',
        ...
        if (obj_save.strId != "") {
            obj_save.action = 'HB_XepLoai_TuKhoa/CapNhat';
        }
        //default
    ...
    cbGenCombo_QuyHocBong: function (data) {
        ...
        var obj = {
            ...
            renderPlace: ["dropSearch_QuyHocBong", "dropQuyHocBong", "dropSearch_QuyHocBongRieng"],
            type: "",
