...
DanhMucDuLieu.prototype = {
    ...
    init: function () {
        ...
        $("#btnRefresh_DMDL").click(function () {
            me.getList_DMDL();
        });
        ...
        --Order: 
        -------------------------------------------*/
        $("#txtSearch_Keyword_DMTB_DMDL").keypress(function (e) {
            if (e.which === 13) {
                e.preventDefault();
                me.getList_DMTB();
            }
        ...
        -------------------------------------------*/
        $('#dropSearch_UngDung_DMDL').on('select2:select', function () {
            me.getList_DMTB();
        });

        $("#btnExport_DMDL").click(function () {
            me.report_Table();
        });
    ...
    getList_DMTB: function () {
        ...
        var strUngDung_Id = edu.util.getValById("dropSearch_UngDung_DMDL");
        ...
        var obj_list = {
            ...
            'strTuKhoa'     : edu.util.getValById("txtSearch_Keyword_DMTB_DMDL"),
    ...
    loadToTree_DMTB: function (dtResult, iPager) {
        var me = this;
        if (edu.util.checkValue(edu.util.getValById("dropSearch_UngDung_DMDL"))) {
            iPager = 0;//khongphantrang
        }
        edu.system.loadPagination(
            "zone_danhmuctenbang_dmdl", 
            "main_doc.DanhMucDuLieu.getList_DMTB()",
            iPager,
            {
                bChange: false,
                bLeft: false
    ...
    genTable_DMDL: function (data, iPager) {
        ...
        edu.system.pagButtonRender("main_doc.DanhMucDuLieu.getList_DMDL()", "tbldata_DMDL", iPager);
        /*II. variable temp*/
        $("#tbldata_DMDL tbody").html('');
        var tBody = "";
        var iStt = 0;
    ...
    cbGenCombo_UngDung: function (data) {
        ...
        var obj = {
            ...
            renderPlace: ["dropSearch_UngDung_DMDL"],
            type: "",
            title: "Chọn ứng dụng"
        };
    ...
    report_Table: function () {
        var me = this;
        //
        var data = edu.util.objGetOneDataInData(me.strDanhMucTenBang_Id, me.dtTenBang, "ID");
        if (data.length != 0) {
            var url_report = edu.system.rootPathReport + "/Modules/Common/ExportDataInDanhMuc.aspx?strMaDanhMucs=" + data.MADANHMUC;
