...
KeHoachXuLy.prototype = {
    ...
    tinhPhiThiTuDong: function (strQLSV_NguoiHoc_Id, strNguonDuLieu_Id) {
        var me = this;
        var obj_save = {
            'action': 'TC_TinhPhi_MH/FSgvKREpKBUpKBU0BS4vJgPP',
            'func': 'pkg_taichinh_tinhphi.TinhPhiThiTuDong',
            'iM': edu.system.iM,
