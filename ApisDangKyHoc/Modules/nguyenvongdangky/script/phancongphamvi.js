...
PhanCongPhamVi.prototype = { 
    ...
    getList_PhanCongPhamVi: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'DKH_NguyenVong_PhamVi/LayDanhSach',
    ...
    save_PhanCongPhamVi: function (strPhamViApDung_Id, strDangKy_LopHocPhan_Id) {
        ...
        //--Edit
        var obj_save = {
            'action': 'DKH_NguyenVong_PhamVi/ThemMoi',
        ...
        if (obj_save.strId != "") {
            ...
            obj_save = {
                'action': 'DKH_NguyenVong_PhamVi/CapNhat',

                'strId': temp.ID,
                'strChucNang_Id': edu.system.strChucNang_Id,
                'strKeHoachNguyenVong_Id': temp.DANGKY_KEHOACHDANGKY_ID,
    ...
    delete_PhanCongPhamVi: function (strId) {
        ...
        var obj = {};
        var obj_delete = {
            'action': 'DKH_NguyenVong_PhamVi/Xoa',
    ...
    genTable_PhanCongPhamVi: function (data, iPager) {
        ...
        me.dtPhanCap.forEach(ele => {
            ...
            if (tempData != undefined && tempData.length > 0) {
                var rowHead = '<table id="tblPhanCong' + ele.ID + '" class="table table-hover table-bordered table-border" style="width: 300px; float: left">';
                rowHead += '<thead>';
                rowHead += '<tr>';
    ...
    getList_QuanSoTheoLop: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'DKH_NguyenVong_PhamVi/LayDSNguoiHoc_NV_PhamVi',
