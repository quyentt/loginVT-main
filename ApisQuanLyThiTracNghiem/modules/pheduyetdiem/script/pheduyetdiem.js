function pheduyetdiem() { };
pheduyetdiem.prototype = {
    dtPhongThi: [],
    dtChiTietPhongThi: [],
    dtPhongThiImport: [],
    dtDeThiThuCong: [],
    ...
    genTable_ChiTietPhongThi: function (strCoTinhLaiDiem, data, iPager) {
        ...
        var jsonForm = {
            ...
            sort: true,
            bPaginate: {
                strFuntionName: "main_doc.pheduyetdiem.getList_ChiTietPhongThi('" + strCoTinhLaiDiem + "')",
                iDataRow: iPager,
                bInfo: false,
                bLeft: false
            },
    ...
    genList_drpDonVi: function (data) {
        var obj = {
            ...
            renderPlace: ["drpDonVi", "drpDonVi_Tab2", "drpDonVi_Tab4","drpDonVi_Tab5"],
            type: "",
            title: "Chọn đơn vị"
        };
    ...
    genTable_PhongThi: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.pheduyetdiem.getList_PhongThi()",
                iDataRow: iPager,
                bInfo: false,
                bLeft: false
            },
    ...
    genTable_PhongThi_Tab2: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.pheduyetdiem.getList_PhongThi_Tab2()",
                iDataRow: iPager,
                bInfo: false,
                bLeft: false
            },
    ...
    genTable_PhongThi_Tab4: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.pheduyetdiem.getList_PhongThi_Tab4()",
                iDataRow: iPager,
                bInfo: false,
                bLeft: false
            },
    ...
    genTable_PhongThi_Tab5: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.pheduyetdiem.getList_PhongThi_Tab5()",
                iDataRow: iPager,
                bInfo: false,
                bLeft: false
            },
    ...
    genTable_CanBoCoiThi: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.pheduyetdiem.getList_CanBoCoiThi()",
                iDataRow: iPager,
                bInfo: false,
                bLeft: false
            },
    ...
    genList_drpHocKy: function (data) {
        var obj = {
            ...
            renderPlace: ["drpHocKy", "drpHocKy_Tab2", "drpHocKy_Tab4","drpHocKy_Tab5"],
            type: "",
            title: "Chọn học kỳ"
        };
        edu.system.loadToCombo_data(obj);
