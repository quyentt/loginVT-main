...
--Note:
----------------------------------------------*/
function Import_SoTienMienGiam() { };
Import_SoTienMienGiam.prototype = {
    objParam_KH: '',
    dtImport: null,
    dtPhaiNop: [],
    strPath: '',
    ...
    init: function () {
        ...
        $("#btnImport_STM").click(function (e) {
            var urlfile = $("#uploadFile_STM").val();
            ...
            var rowHienThi = "";
            rowHienThi += "Học kỳ import: <span style='color: red'>" + getNameInSelect("dropThoiGianDaoDao_STM") + "</span>";
            rowHienThi += "<br/>Import cho khoản phí: <span style='color: red'>" + getNameInSelect("dropLoaiKhoanThu_STM") + "</span>";
            rowHienThi += "<br/><span style='color: red'>" + getNameInSelect("dropChuyenKeToan_STM") + "</span>" + " thực hiện hạch toán";
            rowHienThi += "<br/>Loại kiểm tra: <span style='color: red'>" + getNameInSelect("dropKiemTra_STM") + "</span>";
            rowHienThi += "<br/>Kiểu học: <span style='color: red'>" + edu.util.getValById("dropKieuHoc_STM") + "</span>";
            rowHienThi += "<br/>Ngày giao dịch: <span style='color: red'>" + edu.util.getValById("txtSearch_CongNo_STM") + "</span>";
            rowHienThi += "<br/>Mã đợt import: <span style='color: red'>" + edu.util.getValById("txtSearch_MaDotImport_STM") + "</span>";
        ...
        -------------------------------------------*/
        edu.system.uploadImport(["uploadFile_STM"]);
        $("#btnDocFile").click(function () {
            ...
            main_doc.Import_SoTienMienGiam.getList_DataImport();
        });
    ...
    getList_DataImport: function () {
        var me = main_doc.Import_SoTienMienGiam;
        ...
        var obj_list = {
            ...
            'strPath': edu.util.getValById("uploadFile_STM")
        };
    ...
    import_PhaiNop: function () {
        ...
        var obj_save = {
            ...
            'dChuyenKeToan': edu.util.getValById("dropChuyenKeToan_STM"),
            'dNganh1_2': "1",
            'strTaiChinh_CacKhoanThu_Id': edu.util.getValById("dropLoaiKhoanThu_STM"),
            'strDaoTao_ThoiGianDaoTao_Id': edu.util.getValById("dropThoiGianDaoDao_STM"),
            'strDaoTao_CoSoDaoTao_Id': edu.util.getValById("dropCoSoDaoTao_STM"),
            'strThongTinImport': edu.util.getValById("txtSearch_MaDotImport_STM"),
            'strNgayGiaoDich': edu.util.getValById("txtSearch_CongNo_STM"),
            'dCheDoKiemTraDuLieu': edu.util.getValById("dropKiemTra_STM"),
            'strKieuHoc_Id': edu.util.getValById("dropKieuHoc_STM"),
        ...
        $("#zoneFileDinhKemuploadFile_STM ul").html('');
    ...
    delete_DaImport: function (Ids, bcheck) {
        ...
        //--Edit
        var obj_delete = {
            'action': 'TC_Import_SoTienMienGiam/Xoa',
            'versionAPI': 'v1.0',
            'strIds': Ids,
            'strNguoiThucHien_Id': edu.system.userId
        };
    ...
    genTable_DaImport: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.Import_SoTienMienGiam.getList_DaImport()",
                iDataRow: iPager,
            },
            colPos: {
    ...
    genTable_DaHachToan: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.Import_SoTienMienGiam.getList_DaHachToan()",
                iDataRow: iPager,
            },
            colPos: {
    ...
    cbGenCombo_ThoiGianDaoTao: function (data) {
        ...
        var obj = {
            ...
            renderPlace: ["dropSearch_HocKy", "dropThoiGianDaoDao_STM"],
            type: "",
    ...
    cbGenCombo_KhoanThu: function (data) {
        ...
        var obj = {
            ...
            renderPlace: ["dropSearch_LoaiKhoan", "dropLoaiKhoanThu_STM"],
            type: "",
    ...
    genComBo_KieuHoc: function (data) {
        ...
        var obj = {
            ...
            renderPlace: ["dropKieuHoc_STM", "dropSearch_KieuHoc"],
            type: "",
            title: "Chọn kiểu học",
        }
        edu.system.loadToCombo_data(obj);
    ...
    save_HoachToan: function (strNguonDuLieu_Id, bcheck) {
        ...
        //--Edit
        var obj_save = {
            'action': 'TC_Import_SoTienMienGiam/Sua_ST_Import_DaChuyenKT',
            'versionAPI': 'v1.0',
    ...
    getList_MaThongTin: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'TC_Import_SoTienMienGiam/LayDSThongTinImport_DT_ST',
            'versionAPI': 'v1.0',
