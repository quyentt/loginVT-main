...
ApDungCongThuc.prototype = {
    ...
    init: function () {
        ...
        $("#btnAddNew").click(function () {
            var strHeDaoTao_Id = edu.util.getValById("dropHeDaoTao_ADCT");
        ...
        edu.system.loadToCombo_DanhMucDuLieu("QLTC.NVAP", "dropNghiepVu_ADCT,dropNew_NghiepVu", "Chọn nghiệp vụ áp dụng");
    },
    /*------------------------------------------
    ...
    save_ApDungCongThuc_One: function () {
        ...
        var me = this;
        var obj_save = {
            'action': 'TC_CongThucTinhPhi/ThemMoi',
            'versionAPI': 'v1.0',
        ...
        if (me.strApDungCongThuc_Id != "" && me.strApDungCongThuc_Id != undefined) {
            obj_save.action = "TC_CongThucTinhPhi/CapNhat";
        }
        //default
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    objNotify = {
                        content: "QLTC_CongThucTinhPhi.ThemMoi: " + data.Message,
                        type: "w"
                    }
            ...
            error: function (er) {
                edu.system.alert("QLTC_CongThucTinhPhi.ThemMoi (er): " + JSON.stringify(er));
            },
            type: "POST",
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    edu.system.alert("QLTC_CongThucTinhPhi.ThemMoi: " + data.Message);
                }
    ...
    getList_ThoiGian_ApDungCongThuc: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'TC_CongThucTinhPhi/LayDSThoiGian_CongThucTinhPhi',
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    me.dtCot = data.Data;
                    me.getList_ChuongTrinhDaoTao(edu.util.getValById('dropKhoaDaoTao_ADCT'));
                }
                else {
    ...
    getList_ApDungCongThuc: function () {
        ...
        var obj_list = {
            'action': 'TC_CongThucTinhPhi/LayDanhSach',
            'versionAPI': 'v1.0',
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    edu.system.alert("QLTC_CongThucTinhPhi.LayDanhSach: " + data.Message);
                }
                edu.system.endLoading();
            },
            error: function (er) {
                edu.system.endLoading();
                edu.system.alert("QLTC_CongThucTinhPhi.LayDanhSach (er): " + JSON.stringify(er), "w");
            },
            type: "GET",
            action: obj_list.action,
    ...
    getList_ChuongTrinhDaoTao: function (strKhoaDaoTao_Id, position) {
        ...
        if (!edu.util.checkValue(me.dtChuongTrinhDaoTao)) {//call only one time
            edu.system.getList_ChuongTrinhDaoTao(obj_ChuongTrinhDT, "", "", me.genTable_ChuongTrinhDaoTao);
        }
        else {
            edu.util.objGetDataInData(strKhoaDaoTao_Id, me.dtChuongTrinhDaoTao, "DAOTAO_KHOADAOTAO_ID", me.genTable_ChuongTrinhDaoTao);
        }
    },
    /*------------------------------------------
    ...
    genTable_ChuongTrinhDaoTao: function (data) {
        ...
        me.getList_ApDungCongThuc();
        edu.system.move_ThroughInTable("tblApDungCongThuc");
