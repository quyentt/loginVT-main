...
MucPhiLop.prototype = {
    ...
    init: function () {
        ...
        $("#tblMucPhiLop").delegate(".btnEdit", "click", function () {
            var strId = this.id;
    ...
    save_MucPhiSoTien_One: function () {
        ...
        var obj_save = {
            ...
            'strPhamViApDung_Id': edu.util.getValById('dropNew_Lop'),
            'strPhanCapApDung_Id': "",
    ...
    genTable_ChuongTrinhDaoTao: function (data) {
        ...
        $("#tblMucPhiLop thead tr").html(rowth);
        edu.system.arrId = [];
        for (var i = 0; i < me.dtCot.length; i++) {
        ...
        me.getList_MucPhiSoTien();
        edu.system.move_ThroughInTable("tblMucPhiLop");
    },
