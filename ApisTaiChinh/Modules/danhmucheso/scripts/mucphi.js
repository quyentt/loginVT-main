...
MucPhi.prototype = {
    ...
    init: function () {
        ...
        $('#dropHeDaoTao_MP').on('select2:select', function () {
            var strHeHaoTao_Id = edu.util.getValById("dropHeDaoTao_MP");
            me.getList_KhoaDaoTao(strHeHaoTao_Id);
        });
        $('#dropKhoaDaoTao_MP').on('select2:select', function () {
            me.getList_ThoiGian_MucPhi_SoTien();
            me.getList_ChuongTrinhDaoTao_ComBo();
        });
        $('#dropDonViTinh_MP').on('select2:select', function () {
            if ($('#dropDonViTinh_MP').val() == "") return;
            me.getList_ThoiGianDaoTao();
            me.getList_ThoiGian_MucPhi_SoTien();
        });
        /*------------------------------------------
        ...
        $("#btnUpdate").click(function () {
            ...
            $("#btnYes").click(function (e) {
                $("#btnYes").hide();
                var strTable_Id = "tblMucPhiSoTien";
        ...
        $("#btnAddNew").click(function () {
            var strHeDaoTao_Id = edu.util.getValById("dropHeDaoTao_MP");
            var strKhoaDaoTao_Id = edu.util.getValById("dropKhoaDaoTao_MP");
            var strDonViPhi_Id = edu.util.getValById("dropDonViTinh_MP");
        ...
        $("#tblMucPhiSoTien").delegate(".btnEdit", "click", function () {
            var strId = this.id;
            me.strMucPhi_Id = strId;
            var data = edu.util.objGetDataInData(strId, me.dtMucPhi, "ID");
            me.viewForm_MucPhiSoTien(data[0]);
        });
        edu.system.loadToCombo_DanhMucDuLieu("QLTC.NVAP", "dropNghiepVu_MP,dropNew_NghiepVu", "Chọn nghiệp vụ áp dụng");
    ...
    save_MucPhiSoTien_One: function () {
        ...
        var obj_save = {
            ...
            'strNghiepVuApDung_Id': edu.util.getValById('dropNghiepVu_MP'),
            'strDonViTinh_Id': edu.util.getValById('dropDonViTinh_MP'),
    ...
    save_MucPhiSoTien: function (point) {
        ...
        var obj_save = {
            ...
            'strNguoiThucHien_Id': edu.system.userId,
            'strTaiChinh_CacKhoanThu_Id': edu.util.getValById('dropKhoanThu_MP'),
    ...
    getList_ThoiGian_MucPhi_SoTien: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'TC_MucPhi_SoTien/LayDSThoiGian_MucPhi_SoTien',

            'strDaoTao_ThoiGianDaoTao_Id': edu.util.getValById('dropThoiGianDaoTao_MP'),
            'strHeDaoTao_Id': edu.util.getValById('dropHeDaoTao_MP'),
            'strKhoaDaoTao_Id': edu.util.getValById('dropKhoaDaoTao_MP'),
            'strDonViTinh_Id': edu.util.getValById('dropDonViTinh_MP'),
            'strTaiChinh_CacKhoanThu_Id': edu.util.getValById('dropKhoanThu_MP'),
            'strNghiepVuApDung_Id': edu.util.getValById('dropNghiepVu_MP'),
            'strNguoiThucHien_Id': "",
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    me.dtCot = data.Data;
                    me.getList_ChuongTrinhDaoTao(edu.util.getValById('dropKhoaDaoTao_MP'));
                }
                else {
    ...
    getList_ChuongTrinhDaoTao: function (strKhoaDaoTao_Id, position) {
        ...
        var obj_list = {
            'action': 'TC_MucPhi_SoTien/LayDSTaiChinh_CT_SoTien',
            'versionAPI': 'v1.0',
    ...
    getList_ChuongTrinhDaoTao_ComBo: function (strKhoaDaoTao_Id, position) {
        ...
        var obj_ChuongTrinhDT = {
            strKhoaDaoTao_Id: $("#dropKhoaDaoTao_MP").val(),
            strN_CN_LOP_Id: "",
            strKhoaQuanLy_Id: "",
            strToChucCT_Cha_Id: "",
            strNguoiThucHien_Id: "",
    ...
    genTable_ChuongTrinhDaoTao: function (data) {
        ...
        $("#tblMucPhiSoTien thead tr").html(rowth);
        edu.system.arrId = [];
        for (var i = 0; i < me.dtCot.length; i++) {
        ...
        me.getList_MucPhiSoTien();
        edu.system.move_ThroughInTable("tblMucPhiSoTien");
    },
    ...
    getList_ThoiGianDaoTao: function () {
        ...
        var obj_list = {
            ...
            'strDonViTinh_Id': $("#dropDonViTinh_MP option:selected").attr("id")
        }
    ...
    loadToCombo_ThoiGianDaoTao: function (data) {
        ...
        var obj = {
            ...
            renderPlace: ["dropNew_ThoiGian", "dropThoiGianDaoTao_MP"],
            type: "",
            title: "Chọn học kỳ",
        }
        edu.system.loadToCombo_data(obj);
    ...
    genComBo_KieuHoc: function (data) {
        ...
        var obj = {
            ...
            renderPlace: ["dropKieuHoc_MP", "dropNew_KieuHoc"],
            type: "",
            title: "Chọn kiểu học",
        }
        edu.system.loadToCombo_data(obj);
    ...
    genComBo_KhoanThu: function (data) {
        ...
        var obj = {
            ...
            renderPlace: ["dropKhoanThu_MP", "dropNew_LoaiKhoan"],
            type: "",
    ...
    genComBo_DonViTinh: function (data) {
        ...
        var obj = {
            ...
            renderPlace: ["dropDonViTinh_MP", "dropNew_DonViTinh"],
            type: "",
