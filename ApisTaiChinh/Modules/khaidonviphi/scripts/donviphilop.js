...
DonViPhiLop.prototype = {
    ...
    init: function () {
        ...
        $("#btnUpdate").click(function () {
            ...
            $("#btnYes").click(function (e) {
                $("#btnYes").hide();
                var strTable_Id = "tblDonViPhiLop";
        ...
        $("#tblDonViPhiLop").delegate(".btnEdit", "click", function () {
            var strId = this.id;
    ...
    save_DonViPhiSoTien_One: function () {
        ...
        var obj_save = {
            ...
            'strPhamViApDung_Id': edu.util.getValById('dropLop'),
            'strPhanCapApDung_Id': "",
    ...
    genTable_DonViPhi: function (data) {
        ...
        $("#tblDonViPhiLop thead tr").html(rowth);
        edu.system.arrId = [];
        for (var i = 0; i < me.dtCot.length; i++) {
        ...
        me.getList_DonViPhiSoTien();
        edu.system.move_ThroughInTable("tblDonViPhiLop");
    },
