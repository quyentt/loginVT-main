...
--Date of updated:
----------------------------------------------*/
function SinhVienMienGiamMoi() { };
SinhVienMienGiamMoi.prototype = {
    dtCot: [],
    dtSinhVienMienGiam: [],
    ...
    init: function () {
        ...
        $("#btnSave_SVMGM").click(function () {
            ...
            edu.system.confirm("Bạn có chắc chắn muốn lưu toàn bộ phần trăm miễn giảm không?");
            $("#btnYes").click(function (e) {
                $("#btnYes").hide();
        ...
        //$("#txtPhanTramMienMacDinh").on("keyup", function () {
            
        //});
        $("#btnDienMienTuDong").click(function () {
            var value = $("#txtPhanTramMienMacDinh").val();
    ...
    getList_TaiChinh_NguoiHoc_Mien: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'TC_DoiTuong_MienGiam/LayDSTaiChinh_NguoiHoc_Mien',
    ...
    genTable_SinhVienMienGiam: function (data) {
        var me = main_doc.SinhVienMienGiamMoi;
        var jsonForm = {
    ...
    save_SinhVienMienGiam_One: function () {
        ...
        var obj_save = {
            ...
            'dPhanTramMienGiam': $("#txtEdit_MucMien").val(),
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    edu.system.alert("QLTC_DoiTuong_MienGiam.ThemMoi: " + data.Message);
                }
                edu.system.start_Progress("alertprogessbar", me.endLuuHeSo);
            },
            error: function (er) {
                edu.system.alert("QLTC_DoiTuong_MienGiam.ThemMoi (er): " + JSON.stringify(er));
                edu.system.start_Progress("alertprogessbar", me.endLuuHeSo);
            },
            type: "POST",
            action: obj_save.action,
    ...
    getList_ThoiGian_DoiTuong_Mien: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'TC_DoiTuong_MienGiam/LayDSThoiGian_DoiTuong_Mien',
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    edu.system.alert("QLTC_DoiTuong_MienGiam.LayDanhSach: " + data.Message);
                }
                edu.system.endLoading();
            },
            error: function (er) {
                edu.system.endLoading();
                edu.system.alert("QLTC_DoiTuong_MienGiam.LayDanhSach (er): " + JSON.stringify(er), "w");
            },
            type: "GET",
            action: obj_list.action,
    ...
    viewForm_SinhVienMienGiam: function (data) {
        ...
        edu.util.viewValById("txtEdit_MucMien", data.PHANTRAMMIENGIAM);
    ...
    cbGenTable_SinhVien: function (data, iPager) {
        var me = main_doc.SinhVienMienGiamMoi;//global variable
