...
--Date of updated:
----------------------------------------------*/
function SinhVienSoTienMien() { };
SinhVienSoTienMien.prototype = {
    dtCot: [],
    dtSinhVienMienGiam: [],
    strSinhVienMienGiam_Id: [],
    ...
    init: function () {
        ...
        $('#dropChuongTrinhDaoTao_SVMG').on('select2:select', function () {
            var strKhoaHoc_Id = edu.util.getValById("dropKhoaDaoTao_SVMG");
            var strChuongTrinh_Id = edu.util.getValById("dropChuongTrinhDaoTao_SVMG");
        ...
        $("#btnUpdate").click(function () {
            ...
            $("#btnYes").click(function (e) {
                $("#btnYes").hide();
                var strTable_Id = "tblSinhVienMienGiam";
                ...
                for (var i = 0; i < arrElement.length; i++) {
                    ...
                    if (arrElement[i].value != temp) {
                        ...
                        var obj = {
                            ...
                            strDiem_KieuHoc_Id: $("#dropKieuHoc_SVMG").val(),
                            strTaiChinh_CacKhoanThu_Id: $("#dropKhoanThu_SVMG").val()
                        }
                        if (temp == "") {
                            obj.strDaoTao_ToChucCT_Id = $("#dropChuongTrinhDaoTao_SVMG").val();
                        }
                        arrSave.push(obj);
                    }
                }
                ...
                for (var i = 0; i < arrSave.length; i++) {
                    me.save_SinhVienMienGiam(arrSave[i]);
                }
            });
        });
        $("#btnSave_SVMGM").click(function () {
            var arrValid_HS = [
                //EM-empty, FL-float, IN-int, DA-date, seperated by '#' character...
                { "MA": "dropNew_KhoanThu", "THONGTIN1": "1" },
                { "MA": "dropNew_KieuHoc", "THONGTIN1": "1" },
            ...
            edu.system.confirm("Bạn có chắc chắn muốn lưu toàn bộ số tiền miễn giảm không?");
            $("#btnYes").click(function (e) {
                $("#btnYes").hide();
        ...
        $("#btnSave").click(function () {
            me.save_SinhVienMienGiam_One();
        });
        $("#btnDelete").click(function () {
            me.delete_SinhVienMienGiam(me.strSinhVienMienGiam_Id);
        });
        $("#btnAddNew").click(function () {
            var strHeDaoTao_Id = edu.util.getValById("dropHeDaoTao_SVMG");
            var strKhoaDaoTao_Id = edu.util.getValById("dropKhoaDaoTao_SVMG");
            var strChuongTrinh_Id = edu.util.getValById("dropChuongTrinhDaoTao_SVMG");
            var strLop_Id = edu.util.getValById("dropLopQuanLy_SVMG");
        ...
        $("#tblSinhVienMienGiam").delegate(".btnEdit", "click", function () {
            var strId = this.id;
            me.strSinhVienMienGiam_Id = strId;
            var data = edu.util.objGetDataInData(strId, me.dtSinhVienMienGiam, "ID");
            me.viewForm_SinhVienMienGiam(data[0]);
        });
    ...
    getList_TaiChinh_NguoiHoc_Mien: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'TC_SoTienMien/LayDSTaiChinh_NH_SoTienMien',
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    me.genTable_SinhVienMienGiam(data.Data);
                }
                else {
    ...
    --ULR: Modules
    -------------------------------------------*/
    genTable_SinhVienMienGiam: function (data) {
        var me = main_doc.SinhVienSoTienMien;
        var jsonForm = {
            strTable_Id: "tblSinhVienMienGiam",
            aaData: data,
            colPos: {
                center: [0, 1, 3],
                fix: [0]
        ...
        $("#tblSinhVienMienGiam thead tr").html(rowth);
        edu.system.arrId = [];
        for (var i = 0; i < me.dtCot.length; i++) {
        ...
        me.getList_SinhVienMienGiam();
        edu.system.move_ThroughInTable("tblSinhVienMienGiam");
    },
    /*------------------------------------------
	--Discription: [1] ACCESS DB SinhVienMienGiam
	--ULR:  
	-------------------------------------------*/
    save_SinhVienMienGiam_One: function () {
        me = this;
        console.log($("#dropEdit_DoiTuong").val());

        var data = edu.util.objGetDataInData(me.strSinhVienMienGiam_Id, me.dtSinhVienMienGiam, "ID")[0];

        //reset
        var me = this;
        var obj_save = {
            'action': 'TC_SoTienMien/ThemMoi',
            'versionAPI': 'v1.0',
            ...
            'dSoTien': $("#txtEdit_MucMien").val().replace(/,/g, ""),
        ...
        if (obj_save.strId != "" && obj_save.strId != undefined) {
            obj_save.action = "TC_SoTienMien/CapNhat";
        }
        //default
        edu.system.makeRequest({
            success: function (data) {
    ...
    save_SinhVienMienGiam: function (obj) {
        me = this;
        ...
        var obj_save = {
            ...
            'dSoTien': obj.dPhanTramMienGiam.replace(/,/g, ""),
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    edu.system.alert("QLTC_SoTienMien.ThemMoi: " + data.Message);
                }
                edu.system.start_Progress("alertprogessbar", me.endLuuHeSo);
            },
            error: function (er) {
                edu.system.alert("QLTC_SoTienMien.ThemMoi (er): " + JSON.stringify(er));
                edu.system.start_Progress("alertprogessbar", me.endLuuHeSo);
            },
            type: "POST",
            action: obj_save.action,
    ...
    getList_ThoiGian_DoiTuong_Mien: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'TC_SoTienMien/LayDSThoiGian_DT_SoTienMien',
    ...
    getList_SinhVienMienGiam: function () {
        var me = this;

        var obj_list = {
            'action': 'TC_SoTienMien/LayDanhSach',
            'versionAPI': 'v1.0',
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.dtSinhVienMienGiam = dtResult;
                    me.genData_SinhVienMienGiam(dtResult);
                }
                else {
                    edu.system.alert("QLTC_SoTienMien.LayDanhSach: " + data.Message);
                }
                edu.system.endLoading();
            },
            error: function (er) {
                edu.system.endLoading();
                edu.system.alert("QLTC_SoTienMien.LayDanhSach (er): " + JSON.stringify(er), "w");
            },
            type: "GET",
            action: obj_list.action,
    ...
    --ULR: Modules
    -------------------------------------------*/
    genData_SinhVienMienGiam: function (data) {
        var me = this;
        for (var i = 0; i < data.length; i++) {
            var point = $("#input" + data[i].QLSV_NGUOIHOC_ID + "_" + data[i].DAOTAO_THOIGIANDAOTAO_ID);
            point.val(data[i].SOTIEN);
            point.attr("title", data[i].SOTIEN);
    ...
    viewForm_SinhVienMienGiam: function (data) {
        var me = this;
        //call popup --Edit
        me.popup();
        //view data --Edit
        ...
        edu.util.viewValById("txtEdit_MucMien", data.SOTIEN);
    ...
    cbGenCombo_ChuongTrinhDaoTao: function (data) {
        ...
        var obj = {
            ...
            renderPlace: ["dropChuongTrinhDaoTao_SVMG", "dropChuongTrinhDaoTao_Form_SVMG", "dropEdit_ChuongTrinh"],
            type: "",
    ...
    loadToCombo_ThoiGianDaoTao: function (data) {
        ...
        var obj = {
            ...
            renderPlace: ["dropNew_ThoiGianDaoTao", "dropThoiGianDaoTao_SVMG", "dropEdit_ThoiGian"],
            type: "",
            title: "Chọn học kỳ",
        }
        edu.system.loadToCombo_data(obj);
    ...
    genComBo_KieuHoc: function (data) {
        ...
        var obj = {
            ...
            renderPlace: ["dropKieuHoc_SVMG", "dropNew_KieuHoc", "dropEdit_KieuHoc"],
            type: "",
            title: "Chọn kiểu học",
        }
        edu.system.loadToCombo_data(obj);
    ...
    genComBo_KhoanThu: function (data) {
        ...
        var obj = {
            ...
            renderPlace: ["dropKhoanThu_SVMG", "dropNew_KhoanThu", "dropEdit_LoaiKhoan"],
            type: "",
    ...
    cbGenTable_SinhVien: function (data, iPager) {
        var me = main_doc.SinhVienSoTienMien;//global variable
