...
DanhMucDuLieu.prototype = {
    ...
    genInputForm_DMDL: function () {
        ...
        for (var i = 0; i < me.dtDanhMucThuocTinh.length; i++) {
            ...
            switch (me.dtDanhMucThuocTinh[i].TENTRUONGDULIEU) {
                case "Ten":
                    modalBody += "<div style='width:100%' class='aps-form-item'><div style='width:20%; float:left' class='aps-form-lable'><label style='font-weight:normal'>" + strMoTa + " (*)</label></div>";
                    modalBody += "<div style='width:80%; float:left' class='aps-form-input'><input type='text' id='txtTen' class='form-control'/></div></div>";
                    modalBody += "<div class='clear'></div>";
                    break;
                case "Ma":
                    modalBody += "<div style='width:100%' class='aps-form-item'><div style='width:20%; float:left' class='aps-form-lable'><label style='font-weight:normal'>" + strMoTa + " (*)</label></div>";
                    modalBody += "<div style='width:80%; float:left' class='aps-form-input'><input type='text' id='txtMa' class='form-control'/></div></div>";
                    modalBody += "<div class='clear'></div>";
                    break;
                case "HeSo1":
                    modalBody += "<div style='width:100%' class='aps-form-item'><div style='width:20%; float:left' class='aps-form-lable'><label style='font-weight:normal'>" + strMoTa + "</label></div>";
                    modalBody += "<div style='width:80%; float:left' class='aps-form-input'><input type='text' id='txtHeSo1' class='form-control'/></div></div>";
                    modalBody += "<div class='clear'></div>";
                    break;
                case "HeSo2":
                    modalBody += "<div style='width:100%' class='aps-form-item'><div style='width:20%; float:left' class='aps-form-lable'><label style='font-weight:normal'>" + strMoTa + "</label></div>";
                    modalBody += "<div style='width:80%; float:left' class='aps-form-input'><input type='text' id='txtHeSo2' class='form-control'/></div></div>";
                    modalBody += "<div class='clear'></div>";
                    break;
                case "HeSo3":
                    modalBody += "<div style='width:100%' class='aps-form-item'><div style='width:20%; float:left' class='aps-form-lable'><label style='font-weight:normal'>" + strMoTa + "</label></div>";
                    modalBody += "<div style='width:80%; float:left' class='aps-form-input'><input type='text' id='txtHeSo3' class='form-control'/></div></div>";
                    modalBody += "<div class='clear'></div>";
                    break;
                case "ThongTin1":
                    modalBody += "<div style='width:100%' class='aps-form-item'><div style='width:20%; float:left' class='aps-form-lable'><label style='font-weight:normal'>" + strMoTa + "</label></div>";
                    modalBody += "<div style='width:80%; float:left' class='aps-form-input'><input type='text' id='txtThongTin1' class='form-control'/></div></div>";
                    modalBody += "<div class='clear'></div>";
                    break;
                case "ThongTin2":
                    modalBody += "<div style='width:100%' class='aps-form-item'><div style='width:20%; float:left' class='aps-form-lable'><label style='font-weight:normal'>" + strMoTa + "</label></div>";
                    modalBody += "<div style='width:80%; float:left' class='aps-form-input'><input type='text' id='txtThongTin2' class='form-control'/></div></div>";
                    modalBody += "<div class='clear'></div>";
                    break;
                case "ThongTin3":
                    modalBody += "<div style='width:100%' class='aps-form-item'><div style='width:20%; float:left' class='aps-form-lable'><label style='font-weight:normal'>" + strMoTa + "</label></div>";
                    modalBody += "<div style='width:80%; float:left' class='aps-form-input'><input type='text' id='txtThongTin3' class='form-control'/></div></div>";
                    modalBody += "<div class='clear'></div>";
                    break;
                case "ThongTin4":
                    modalBody += "<div style='width:100%' class='aps-form-item'><div style='width:20%; float:left' class='aps-form-lable'><label style='font-weight:normal'>" + strMoTa + "</label></div>";
                    modalBody += "<div style='width:80%; float:left' class='aps-form-input'><input type='text' id='txtThongTin4' class='form-control'/></div></div>";
                    modalBody += "<div class='clear'></div>";
                    break;
                case "ThongTin5":
                    modalBody += "<div style='width:100%' class='aps-form-item'><div style='width:20%; float:left' class='aps-form-lable'><label style='font-weight:normal'>" + strMoTa + "</label></div>";
                    modalBody += "<div style='width:80%; float:left' class='aps-form-input'><input type='text' id='txtThongTin5' class='form-control'/></div></div>";
                    modalBody += "<div class='clear'></div>";
                    break;
                case "ThongTin6":
                    modalBody += "<div style='width:100%' class='aps-form-item'><div style='width:20%; float:left' class='aps-form-lable'><label style='font-weight:normal'>" + strMoTa + "</label></div>";
                    modalBody += "<div style='width:80%; float:left' class='aps-form-input'><input type='text' id='txtThongTin6' class='form-control'/></div></div>";
                    modalBody += "<div class='clear'></div>";
                    break;
                default:
            }
        }
        modalBody += "<div style='width:100%' class='aps-form-item'><div style='width:20%; float:left' class='aps-form-lable'><label style='font-weight:normal'>Mô tả</label></div>";
        modalBody += "<div style='width:80%; float:left' class='aps-form-input'><input type='text' id='txtMoTa' class='form-control'/></div></div>";
        modalBody += "<div class='clear'></div>";
        modalBody += "<div style='width:100%' class='aps-form-item'><div style='width:20%; float:left' class='aps-form-lable'><label style='font-weight:normal'>Dữ liệu cha</label></div>";
        modalBody += "<div style='width:80%; float:left' class='aps-form-input'><select id='DropDuLieuCha' class='select-opt'></select></div>";
        modalBody += "<div class='clear'></div>";
