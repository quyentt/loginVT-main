...
LopHocPhan.prototype = {
    ...
    init: function () {
        ...
        $("#btnSave_PhanQuyen").click(function () {
            var arrCheckedDuLieu_Id = edu.util.getArrCheckedIds("tblLopHocPhan", "checkX");
        ...
        $("#tblLopHocPhan").delegate('.btnDSQuyen', 'click', function (e) {
            var strId = this.id;
    ...
    save_PhanQuyen: function (strDangKy_LopHocPhan_Id, strNguoiDung_Id, strHanhDong_Id) {
        var me = this;
        var obj_save = {
            'action': 'CMS_PhanQuyenDuLieu/Them_DuLieu_LopHocPhan',
            'type': 'POST',
            'strDangKy_LopHocPhan_Id': strDangKy_LopHocPhan_Id,
    ...
    delete_PhanQuyen: function (strId) {
        ...
        var obj = {};
        var obj_list = {
            'action': 'CMS_PhanQuyenDuLieu/Xoa_DuLieu_LopHocPhan',
            'type': 'POST',
            'strId': strId,
            'strNguoiThucHien_Id': edu.system.userId,
        };
    ...
    getList_PhanQuyen: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'CMS_PhanQuyenDuLieu/LayDSQuyenDuLieu_LopHocPhan',
            'type': 'GET',
            'strDangKy_LopHocPhan_Id': me.strThi_DotPhach_Id,
            'strNguoiThucHien_Id': edu.system.userId,
        };
        //
        edu.system.makeRequest({
