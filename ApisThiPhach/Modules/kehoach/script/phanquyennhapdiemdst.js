...
NhapDiem.prototype = {
    ...
    init: function () {
        ...
        $("#btnSave_PhanQuyen").click(function () {
            var arrCheckedDuLieu_Id = edu.util.getArrCheckedIds("tblNhapDiem", "checkX");
        ...
        var jsonForm = {
            ...
            aoColumns: [
                ...
                },
                {
                    "mDataP": "TEN",
                    "mRender": function (nRow, aData) {
                        return '<span><a class="btn btn-default btnEdit" id="' + aData.ID + '" title="Chi tiết">' + edu.util.returnEmpty(aData.THONGTINLOPHOCPHAN) + '</a></span>';
                    }
                },
    ...
    getList_PhanQuyen: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'CMS_PhanQuyenDuLieu/LayDSQuyenThi_GV_NhapDiem',
            'type': 'GET',
            'strDST_Tui_Id': me.strThi_DotPhach_Id,
            'strNguoiThucHien_Id': edu.system.userId,
        };
        //
        edu.system.makeRequest({
