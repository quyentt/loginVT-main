...
systemextend.prototype = {
    ...
    genModal_SinhVien: function (callback, hideChonNhieu) {
        ...
        html += '</div>';
        html += '<div class="item-modal">';
        html += '<a class="btn btn-default" href="#" id="btnAdd_He"><i class="fa fa-plus fa-customer"></i> Thêm từng hệ</a>';
        html += '</div>';
        html += '<div class="item-modal">';
        ...
        html += '</div>';
        html += '<div class="item-modal">';
        html += '<a class="btn btn-default" href="#" id="btnAdd_KhoaKhoa"><i class="fa fa-plus fa-customer"></i> Thêm Khoa quản lý - khóa học</a>';
        html += '</div>';
        html += '</div>';
        html += '</div>';
        html += '</div>';
