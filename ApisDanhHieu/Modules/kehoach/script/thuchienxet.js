...
ThucHienXet.prototype = {
    ...
    save_ThucHienXet: function (strXLDH_KeHoach_Id) {
        var me = this;
        //--Edit
        var obj_save = {
    ...
    delete_ThucHienXet: function (strXLDH_KeHoach_Id) {
        var me = this;
        //--Edit
        var obj = {};
        var obj_delete = {
   ...
   -------------------------------------------*/
    ...
    getList_PhanCong: function (strXLDH_KeHoach_Id) {
        var me = this;

        //--Edit
        var obj_list = {
            'action': 'HB_XepLoaiDanhHieu/LayDSXLDH_KeHoach_NhanSu',
            'strTuKhoa': edu.util.getValById('txtAAAA'),
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    $("#DSPhanCong" + strXLDH_KeHoach_Id).html(arrNhanSu.toString());
                }
                else {
   ...
   --ULR:  Modules
   -------------------------------------------*/
    getList_DoiTuong: function (strXLDH_KeHoach_Id) {
        var me = this;
        ...
        var obj_list = {
            ...
            'strXLDH_KeHoach_Id': me.strDoiTuongXet_Id,
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.genTable_QuanSoTheoLop(data.Data, data.Pager);
                }
                else {
                    edu.system.alert(obj_list.action + ": " + data.Message, "w");
                }
    ...
    genTable_QuanSoTheoLop: function (data, iPager, strXLDH_KeHoach_Id) {
        var me = this;
        var jsonForm = {
            strTable_Id: "tblQuanSoLop",

            bPaginate: {
                strFuntionName: "main_doc.ThucHienXet.getList_DoiTuong('" + strXLDH_KeHoach_Id + "')",
                iDataRow: iPager,
            },
            aaData: data,
            colPos: {
   ...
   -------------------------------------------*/
    getList_SinhVien: function () {
        ...
        var obj_list = {
            ...
            'strTuKhoa': edu.util.getValById('txtAAAA'),
            'strNguoiDung_Id': edu.util.getValById('dropAAAA'),
            'strXLDH_KeHoach_Id': me.strKeHoachXuLy_Id,
            'strNguoiTao_Id': edu.util.getValById('dropAAAA'),
            'pageIndex': 1,
            'pageSize': 100000,
        };
    ...
    save_SinhVien: function (strNhanSu_Id, strQLSV_KeHoachXuLy_Id) {
        ...
        var obj_save = {
            ...
            'strId': "",
            'strChucNang_Id': edu.system.strChucNang_Id,
            'strXLDH_KeHoach_Id': strQLSV_KeHoachXuLy_Id,
    ...
    save_ThanhVien: function (strNhanSu_Id, strRowID, strKeHoachXuLy_Id) {
        ...
        var obj_save = {
            ...
            'strId': strId,
            'strChucNang_Id': edu.system.strChucNang_Id,
            'strXLDH_KeHoach_Id': strKeHoachXuLy_Id,
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.getList_Dat(strXLDH_KeHoach_Id);
                }
                else {
                    edu.system.alert(obj_list + " : " + data.Message, "s");
                }
    ...
    getList_Dat: function (strXLDH_KeHoach_Id) {
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    var dtReRult = data.Data;
                    me.genTable_Dat(dtReRult, data.Pager, strXLDH_KeHoach_Id);
                }
                else {
                    edu.system.alert(obj_list + " : " + data.Message, "s");
                }
    ...
    genTable_Dat: function (data, iPager, strXLDH_KeHoach_Id) {
        var me = this;
        ...
        var jsonForm = {
            ...
            bPaginate: {
                strFuntionName: "main_doc.ThucHienXet.getList_Dat('" + strXLDH_KeHoach_Id + "')",
                iDataRow: iPager,
            },
            aaData: data,
            colPos: {
        ...
        for (var i = 0; i < me.dtDat_ChiTiet.rsDuLieu.length; i++) {
            ...
            $("#zone_" + aData.XLDH_KETQUA_ID  + "_" + aData.ID).html(edu.util.returnEmpty(aData.GIATRI));
        }
        /*III. Callback*/
    },
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.getList_KhongDat(strXLDH_KeHoach_Id);
                }
                else {
                    edu.system.alert(obj_list + " : " + data.Message, "s");
                }
    ...
    getList_KhongDat: function (strXLDH_KeHoach_Id) {
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    var dtReRult = data.Data;
                    me.genTable_KhongDat(dtReRult, data.Pager, strXLDH_KeHoach_Id);
                }
                else {
                    edu.system.alert(obj_list + " : " + data.Message, "s");
                }
    ...
    genTable_KhongDat: function (data, iPager, strXLDH_KeHoach_Id) {
        var me = this;
        me["dtKhongDat"] = data;
        ...
        var jsonForm = {
            ...
            bPaginate: {
                strFuntionName: "main_doc.ThucHienXet.getList_KhongDat('" + strXLDH_KeHoach_Id + "')",
                iDataRow: iPager,
            },
            aaData: data,
            colPos: {
    ...
    getList_KhongDat_HocPhan: function (strQLSV_NguoiHoc_Id) {
        ...
        var obj_list = {
            ...
            'strXLDH_KeHoach_Id': aData.TN_KEHOACH_ID,
    ...
    genTable_KhongDat_HocPhan: function (data, iPager, strXLDH_KeHoach_Id) {
        var me = this;
