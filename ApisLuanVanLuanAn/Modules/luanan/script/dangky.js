...
DangKy.prototype = {
    ...
    init: function () {
        ...
        $(".btnDelete").click(function () {
            if (edu.util.checkValue(me.strDangKy_Id)) {
        ...
        $("#tblDangKy").delegate(".btnEdit", "click", function () {
            var strId = this.id;
            if (edu.util.checkValue(strId)) {
                me.toggle_form_input();
                me.strDangKy_Id = strId;
                //me.getList_DangKy_ThanhVien();
                edu.util.setOne_BgRow(strId, "tblDangKy");
                me.viewForm_DangKy(edu.util.objGetOneDataInData(strId, me.dtDangKy, "ID"));
        ...
        //        $("#btnYes").click(function (e) {
        //            me.delete_DangKy_ThanhVien(strNhanSu_Id);
        //        });
        //    }
        //});
        /*------------------------------------------
        ...
        //    me.genHTML_DangKy_HeKhoa(id, "");
        //});
        //$("#zone_input_DangKy").delegate(".deleteRowButton", "click", function () {
        //    var strRowId = this.id;
        //    $("#tbl_HeKhoa tr[id='" + strRowId + "']").remove();
        //});
        //$("#zone_input_DangKy").delegate(".deleteHeKhoa", "click", function () {
        //    var strId = this.id;
        //    edu.system.confirm(edu.constant.getting("NOTIFY", "CF_DELETE"));
        //    $("#btnYes").click(function (e) {
        //        me.delete_DangKy_HeKhoa(strId);
        //    });
        //});
    ...
    page_load: function () {
        ...
        edu.system.loadToCombo_DanhMucDuLieu("LVLA.VTHD", "", "", function (data) {
            main_doc.DangKy.dtVaiTro = data;
        });
        edu.system.loadToCombo_DanhMucDuLieu("LVLA.PLCD", "dropPhanLoai");
    },

    toggle_notify: function () {
        edu.util.toggle_overide("zone-bus", "zone_notify_DangKy");
    },
    toggle_form_input: function () {
        edu.util.toggle_overide("zone-bus", "zone_input_DangKy");
    },
    ...
    save_DangKy: function () {
        ...
        //--Edit
        var obj_save = {
            'action': 'LVLA_DangKy_ChuyenDe/ThemMoi',


            'strId': me.strDangKy_Id,
        ...
        if (obj_save.strId !== "") {
            obj_save.action = 'LVLA_DangKy_ChuyenDe/CapNhat';
        }
        //default
            ...
            success: function (data) {
                if (data.Success) {
                    ...
                    $("#tblInputDanhSachNhanSu tbody tr").each(function () {
                        ...
                        me.save_DangKy_ThanhVien(strNhanSu_Id, strId, $(this).attr("name"));
                    });
                    me.getList_DangKy();
                }
                else {
    ...
    delete_DangKy: function () {
        var me = this;
        //--Edit
        var obj_delete = {
            'action': 'LVLA_DangKy_ChuyenDe/Xoa',

            'strIds': me.strDangKy_Id,
            'strNguoiThucHien_Id': edu.system.userId
        };
        //default
    ...
    --ULR:  Modules
    -------------------------------------------*/
    save_DangKy_ThanhVien: function (strNhanSu_Id, strDangKy_Id, strId) {
        var me = this;
        ...
        var obj_save = {
            ...
            'strId': strId,
            'strChucNang_Id': edu.system.strChucNang_Id,
            'strLVLA_DeCuong_DangKy_Id': strDangKy_Id,
    ...
    getList_DangKy_ThanhVien: function () {
        var me = this;
        ...
        var obj_list = {
            ...
            'strLVLA_KeHoach_DeCuong_Id': me.dtDangKy.find(e => e.ID === me.strDangKy_Id).LVLA_KEHOACH_DECUONG_ID,
            'strLVLA_DeCuong_DangKy_Id': me.strDangKy_Id,
            'strNguoiThucHien_Id': edu.system.userId,
            'pageIndex': 1,
            'pageSize': 100000,
        };
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.genTable_DangKy_ThanhVien(dtResult);
                }
                else {
                    edu.system.alert(obj_list.action + ": " + data.Message, "w");
                }
    ...
    delete_DangKy_ThanhVien: function (strNhanSu_Id) {
        var me = this;
        //--Edit
        var obj = {};
        var obj_delete = {
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    obj = {
                        content: "TS_DangKy_NhanSu/Xoa: " + data.Message,
                        code: ""
                    };
                    edu.system.afterComfirm(obj);
                }
            ...
            error: function (er) {
                var obj = {
                    content: "TS_DangKy_NhanSu/Xoa (er): " + JSON.stringify(er),
                    code: "w"
                };
                edu.system.afterComfirm(obj);
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genTable_DangKy_ThanhVien: function (data) {
        var me = this;
        //3. create html
        me.arrNhanSu_Id = [];
        $("#tblInputDanhSachNhanSu tbody").html("");
