...
HoiDongThongQua.prototype = {
    ...
    init: function () {
        ...
        $("#zoneBtnXacNhan").delegate('.btnxacnhan', 'click', function () {
            ...
            if (me.strHoiDongThongQua_Id != "") {
                arrChecked_Id = [me.strHoiDongThongQua_Id];
            } else {
                var arrChecked_Id = edu.util.getArrCheckedIds("tblHoiDongThongQua", "checkX");
            }
            if (arrChecked_Id.length > 0) {
        ...
        $("[id$=chkSelectAll]").on("click", function () {
            edu.util.checkedAll_BgRow(this, { table_id: "tblHoiDongThongQua" });
        });
    },
    page_load: function () {
        var me = this;
    ...
    loadBtnXacNhan: function (data) {
        main_doc.HoiDongThongQua.dtXacNhan = data;
        var row = "";
    ...
    getList_HoiDongThongQua: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'LVLA_DeCuong_DangKy/LayDanhSach',
    ...
    save_HoiDongThongQua: function () {
        ...
        //--Edit
        var obj_save = {
            'action': 'LVLA_DeCuong_DangKy/ThemMoi',


            'strId': me.strHoiDongThongQua_Id,
        ...
        if (obj_save.strId !== "") {
            obj_save.action = 'LVLA_DeCuong_DangKy/CapNhat';
        }
        //default
    ...
    getList_HoiDongThongQua_HuongDan: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'LVLA_DeCuong_DangKy_HuongDan/LayDanhSach',
            'strTuKhoa': edu.util.getValById('txtAAAA'),
            'strLVLA_KeHoach_DeCuong_Id': me.dtHoiDongThongQua.find(e => e.ID === me.strHoiDongThongQua_Id).LVLA_KEHOACH_DECUONG_ID,
            'strNguoiDung_Id': edu.util.getValById('dropAAAA'),
            'strLVLA_DeCuong_DangKy_Id': me.strHoiDongThongQua_Id,
            'strNguoiThucHien_Id': edu.system.userId,
            'pageIndex': 1,
            'pageSize': 100000,
        };
    ...
    save_HoiDongThongQua_ThanhVien: function (strNhanSu_Id, strHoiDongThongQua_Id, strId) {
        ...
        var obj_save = {
            'action': 'LVLA_DeCuong_HoiDong_ThanhVien/ThemMoi',


            'strId': strId,
            'strChucNang_Id': edu.system.strChucNang_Id,
            'strLVLA_DeCuong_DangKy_Id': strHoiDongThongQua_Id,
        ...
        if (edu.util.checkValue(obj_save.strId)) {
            obj_save.action = 'LVLA_DeCuong_HoiDong_ThanhVien/CapNhat';
        }
        //default
    ...
    getList_HoiDongThongQua_ThanhVien: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'LVLA_DeCuong_HoiDong_ThanhVien/LayDanhSach',
            'strTuKhoa': edu.util.getValById('txtAAAA'),
            'strNguoiDung_Id': edu.util.getValById('dropAAAA'),
            'strLVLA_KeHoach_DeCuong_Id': me.dtHoiDongThongQua.find(e => e.ID === me.strHoiDongThongQua_Id).LVLA_KEHOACH_DECUONG_ID,
            'strLVLA_DeCuong_DangKy_Id': me.strHoiDongThongQua_Id,
    ...
    delete_HoiDongThongQua_ThanhVien: function (strNhanSu_Id) {
        ...
        var obj = {};
        var obj_delete = {
            'action': 'LVLA_DeCuong_HoiDong_ThanhVien/Xoa',
    ...
    genTable_HoiDongThongQua_ThanhVien: function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            html += "<td class='td-center'>" + (i + 1) + "</td>";
            html += "<td class='td-left'><span>" + data[i].THANHVIEN_HOTEN + "</span></td>";
