...
--Date of updated:
----------------------------------------------*/
function DangKyDeCuong() { };
DangKyDeCuong.prototype = {
    strDangKyDeCuong_Id: '',
    dtDangKyDeCuong: [],
    dtHeDaoTao: [],
    dtKhoaDaoTao: [],
    ...
    init: function () {
        ...
        $("#btnSave").click(function () {
            me.save_DangKyDeCuong();
        });
        $(".btnDelete").click(function () {
            if (edu.util.checkValue(me.strDangKyDeCuong_Id)) {
                edu.system.confirm("Bạn có chắc chắn xóa dữ liệu không?");
                $("#btnYes").click(function (e) {
                    me.delete_DangKyDeCuong();
                });
                return false;
            }
            else {
        ...
        $("#tblDangKyDeCuong").delegate(".btnEdit", "click", function () {
            var strId = this.id;
            if (edu.util.checkValue(strId)) {
                me.toggle_form_input();
                me.strDangKyDeCuong_Id = strId;
                me.getList_DangKyDeCuong_ThanhVien();
                edu.util.setOne_BgRow(strId, "tblDangKyDeCuong");
                me.viewForm_DangKyDeCuong(edu.util.objGetOneDataInData(strId, me.dtDangKyDeCuong, "ID"));
        ...
        $("#tblInputDanhSachNhanSu").delegate('.btnDeletePoiter', 'click', function () {
            ...
            if (!edu.util.checkValue(strcheck)) {
                ...
                $("#btnYes").click(function (e) {
                    me.delete_DangKyDeCuong_ThanhVien(strNhanSu_Id);
                });
            }
        });
        /*------------------------------------------
        ...
        $("#btnThemHeKhoa").click(function () {
            ...
            me.genHTML_DangKyDeCuong_HeKhoa(id, "");
        });
        $("#zone_input_DangKyDeCuong").delegate(".deleteRowButton", "click", function () {
            var strRowId = this.id;
            $("#tbl_HeKhoa tr[id='" + strRowId + "']").remove();
        });
        $("#zone_input_DangKyDeCuong").delegate(".deleteHeKhoa", "click", function () {
            var strId = this.id;
            edu.system.confirm(edu.constant.getting("NOTIFY", "CF_DELETE"));
            $("#btnYes").click(function (e) {
                me.delete_DangKyDeCuong_HeKhoa(strId);
            });
        });
        ...
        edu.system.getList_MauImport("zonebtnDKDC");
    },
    page_load: function () {
        var me = this;
        /*------------------------------------------
        ...
        edu.system.loadToCombo_DanhMucDuLieu("LVLA.VTHD", "", "", function (data) {
            main_doc.DangKyDeCuong.dtVaiTro = data;
        });
    },

    toggle_notify: function () {
        edu.util.toggle_overide("zone-bus", "zone_notify_DangKyDeCuong");
    },
    toggle_form_input: function () {
        edu.util.toggle_overide("zone-bus", "zone_input_DangKyDeCuong");
    },

    rewrite: function () {
        //reset id
        var me = this;
        var strUnhide = "#dropHeDaoTao,#dropKhoaDaoTao,#dropChuongTrinh,#dropLop,#dropHocVien";
        $(strUnhide).attr("disabled", false); 
        me.strDangKyDeCuong_Id = "";
    ...
    getList_DangKyDeCuong: function () {
        var me = this;
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.dtDangKyDeCuong = dtResult;
                    me.genTable_DangKyDeCuong(dtResult, iPager);
                }
                else {
            ...
            success: function (data) {
                if (data.Success) {
                    ...
                    $("#tblInputDanhSachNhanSu tbody tr").each(function () {
                        ...
                        me.save_DangKyDeCuong_ThanhVien(strNhanSu_Id, strId, $(this).attr("name"));
                    });
                    me.getList_DangKyDeCuong();
                }
                else {
    ...
    delete_DangKyDeCuong: function () {
        var me = this;
        //--Edit
        var obj_delete = {
            'action': 'LVLA_DeCuong_DangKy/Xoa',

            'strIds': me.strDangKyDeCuong_Id,
            'strNguoiThucHien_Id': edu.system.userId
        };
        //default
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genTable_DangKyDeCuong: function (data, iPager) {
        var me = this;
        $("#lblDangKyDeCuong_Tong").html(iPager);
        var jsonForm = {
            strTable_Id: "tblDangKyDeCuong",
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.DangKyDeCuong.getList_DangKyDeCuong()",
                iDataRow: iPager
            },
            sort: true,
            colPos: {
    ...
    viewForm_DangKyDeCuong: function (data) {
    ...
    --ULR:  Modules
    -------------------------------------------*/
    save_DangKyDeCuong_ThanhVien: function (strNhanSu_Id, strDangKyDeCuong_Id, strId) {
        var me = this;
        ...
        var obj_save = {
            'action': 'LVLA_DeCuong_DangKy_HuongDan/ThemMoi',


            'strId': strId,
            'strChucNang_Id': edu.system.strChucNang_Id,
            'strLVLA_DeCuong_DangKy_Id': strDangKyDeCuong_Id,
        ...
        if (edu.util.checkValue(obj_save.strId)) {
            obj_save.action = 'LVLA_DeCuong_DangKy_HuongDan/CapNhat';
        }
        //default
    ...
    getList_DangKyDeCuong_ThanhVien: function () {
        var me = this;
        ...
        var obj_list = {
            ...
            'strLVLA_KeHoach_DeCuong_Id': me.dtDangKyDeCuong.find(e => e.ID === me.strDangKyDeCuong_Id).LVLA_KEHOACH_DECUONG_ID,
            'strLVLA_DeCuong_DangKy_Id': me.strDangKyDeCuong_Id,
            'strNguoiThucHien_Id': edu.system.userId,
            'pageIndex': 1,
            'pageSize': 100000,
        };
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.genTable_DangKyDeCuong_ThanhVien(dtResult);
                }
                else {
                    edu.system.alert(obj_list.action + ": " + data.Message, "w");
                }
    ...
    delete_DangKyDeCuong_ThanhVien: function (strNhanSu_Id) {
        var me = this;
        //--Edit
        var obj = {};
        var obj_delete = {
            'action': 'LVLA_DeCuong_DangKy_HuongDan/Xoa',
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    obj = {
                        content: "TS_DangKyDeCuong_NhanSu/Xoa: " + data.Message,
                        code: ""
                    };
                    edu.system.afterComfirm(obj);
                }
            ...
            error: function (er) {
                var obj = {
                    content: "TS_DangKyDeCuong_NhanSu/Xoa (er): " + JSON.stringify(er),
                    code: "w"
                };
                edu.system.afterComfirm(obj);
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genTable_DangKyDeCuong_ThanhVien: function (data) {
        var me = this;
        //3. create html
        me.arrNhanSu_Id = [];
        $("#tblInputDanhSachNhanSu tbody").html("");
