...
--Date of updated:
----------------------------------------------*/
function BaoVeCapCoSo() { };
BaoVeCapCoSo.prototype = {
    strBaoVeCapCoSo_Id: '',
    dtBaoVeCapCoSo: [],
    dtHeDaoTao: [],
    dtKhoaDaoTao: [],
    ...
    init: function () {
        ...
        $("#btnSave").click(function () {
            me.save_BaoVeCapCoSo();
        });
        $(".btnDelete").click(function () {
            if (edu.util.checkValue(me.strBaoVeCapCoSo_Id)) {
                edu.system.confirm("Bạn có chắc chắn xóa dữ liệu không?");
                $("#btnYes").click(function (e) {
                    me.delete_BaoVeCapCoSo();
                });
                return false;
            }
            else {
        ...
        $("#tblBaoVeCapCoSo").delegate(".btnEdit", "click", function () {
            var strId = this.id;
            if (edu.util.checkValue(strId)) {
                me.toggle_form_input();
                me.strBaoVeCapCoSo_Id = strId;
                me.getList_BaoVeCapCoSo_HuongDan();
                me.getList_BaoVeCapCoSo_ThanhVien();
                me.getList_BaoVeCapCoSo_Lich();
                edu.util.setOne_BgRow(strId, "tblBaoVeCapCoSo");
                me.viewForm_BaoVeCapCoSo(edu.util.objGetOneDataInData(strId, me.dtBaoVeCapCoSo, "ID"));
        ...
        $("#tblInputDanhSachNhanSu").delegate('.btnDeletePoiter', 'click', function () {
            ...
            if (!edu.util.checkValue(strcheck)) {
                ...
                $("#btnYes").click(function (e) {
                    me.delete_BaoVeCapCoSo_ThanhVien(strNhanSu_Id);
                });
            }
        });
        ...
        $("#btnThemLich").click(function () {
            ...
            me.genHTML_BaoVeCapCoSo_Lich(id, "");
        });
        $("#zone_input_BaoVeCapCoSo").delegate(".deleteRowButton", "click", function () {
            var strRowId = this.id;
            $("#tbl_Lich tr[id='" + strRowId + "']").remove();
        });
        $("#zone_input_BaoVeCapCoSo").delegate(".deleteHeKhoa", "click", function () {
            var strId = this.id;
            edu.system.confirm(edu.constant.getting("NOTIFY", "CF_DELETE"));
            $("#btnYes").click(function (e) {
                me.delete_BaoVeCapCoSo_Lich(strId);
            });
        });
        ...
        $("#zoneBtnXacNhan").delegate('.btnxacnhan', 'click', function (e) {
            ...
            if (me.strBaoVeLuanVan_Id != "") {
                arrChecked_Id = [me.strBaoVeCapCoSo_Id];
            } else {
    ...
    page_load: function () {
        ...
        edu.system.loadToCombo_DanhMucDuLieu("LVLA.VTHDONG", "", "", function (data) {
            main_doc.BaoVeCapCoSo.dtVaiTro = data;
        });
        edu.system.loadToCombo_DanhMucDuLieu("LVLA.DGHD", "", "", function (data) {
            main_doc.BaoVeCapCoSo.dtDanhGia = data;
        });
    },
    loadBtnXacNhan: function (data) {
        main_doc.BaoVeCapCoSo.dtXacNhan = data;
        var row = "";
    ...
    toggle_notify: function () {
        edu.util.toggle_overide("zone-bus", "zone_notify_BaoVeCapCoSo");
    },
    toggle_form_input: function () {
        edu.util.toggle_overide("zone-bus", "zone_input_BaoVeCapCoSo");
    },
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.dtBaoVeCapCoSo = dtResult;
                    me.genTable_BaoVeCapCoSo(dtResult, iPager);
                }
                else {
    ...
    save_BaoVeCapCoSo: function () {
        var me = this;
        var strId = me.strBaoVeCapCoSo_Id;
        $("#tblInputDanhSachNhanSu tbody tr").each(function () {
            var strNhanSu_Id = this.id.replace(/rm_row/g, '');
            me.save_BaoVeCapCoSo_ThanhVien(strNhanSu_Id, strId, $(this).attr("name"));
        });
        $("#tbl_Lich tbody tr").each(function () {
            var strLich_Id = this.id.replace(/rm_row/g, '');
            me.save_BaoVeCapCoSo_Lich(strLich_Id, strId, $(this).attr("name"));
        });
    },
    delete_BaoVeCapCoSo: function () {
        var me = this;
        //--Edit
        var obj_delete = {
            'action': 'LVLA_DeCuong_DangKy/Xoa',

            'strIds': me.strBaoVeCapCoSo_Id,
            'strNguoiThucHien_Id': edu.system.userId
        };
        //default
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genTable_BaoVeCapCoSo: function (data, iPager) {
        var me = this;
        $("#lblBaoVeCapCoSo_Tong").html(iPager);
        var jsonForm = {
            strTable_Id: "tblBaoVeCapCoSo",
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.BaoVeCapCoSo.getList_BaoVeCapCoSo()",
                iDataRow: iPager
            },
            sort: true,
            colPos: {
    ...
    viewForm_BaoVeCapCoSo: function (data) {
        var me = main_doc.BaoVeCapCoSo;
        //view data --Edit
    ...
    --ULR:  Modules
    -------------------------------------------*/
    getList_BaoVeCapCoSo_HuongDan: function () {
        var me = this;
        ...
        var obj_list = {
            ...
            'strLVLA_DeCuong_DangKy_Id': me.strBaoVeCapCoSo_Id,
            'strQLSV_NguoiHoc_Id': edu.util.getValById('dropAAAA'),
            'strNguoiHuongDan_Id': edu.util.getValById('dropAAAA'),
            'strVaiTro_Id': edu.util.getValById('dropAAAA'),
            'strLVLA_KeHoach_DeCuong_Id': me.dtBaoVeCapCoSo.find(e => e.ID === me.strBaoVeCapCoSo_Id).LVLA_KEHOACH_DECUONG_ID,
            'strLVLA_DeCuong_ChinhThuc_Id': me.strBaoVeCapCoSo_Id,
            'strNguoiThucHien_Id': edu.system.userId,
            'pageIndex': 1,
            'pageSize': 100000,
        };
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.genTable_BaoVeCapCoSo_HuongDan(dtResult);
                }
                else {
                    edu.system.alert(obj_list.action + ": " + data.Message, "w");
                }
    ...
    genTable_BaoVeCapCoSo_HuongDan: function (data) {
        var me = this;
        //3. create html
    ...
    --ULR:  Modules
    -------------------------------------------*/
    save_BaoVeCapCoSo_ThanhVien: function (strNhanSu_Id, strBaoVeCapCoSo_Id, strId) {
        var me = this;
        ...
        var obj_save = {
            'action': 'LVLA_BaoVe_CoSo_HoiDong_ThanhVien/ThemMoi',
            ...
            'strLVLA_DeCuong_ChinhThuc_Id': strBaoVeCapCoSo_Id,
        ...
        if (edu.util.checkValue(obj_save.strId)) {
            obj_save.action = 'LVLA_BaoVe_CoSo_HoiDong_ThanhVien/CapNhat';
        }
        //default
    ...
    getList_BaoVeCapCoSo_ThanhVien: function () {
        var me = this;

        //--Edit
        var obj_list = {
            'action': 'LVLA_BaoVe_CoSo_HoiDong_ThanhVien/LayDanhSach',
            'strTuKhoa': edu.util.getValById('txtAAAA'),
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.genTable_BaoVeCapCoSo_ThanhVien(dtResult);
                }
                else {
                    edu.system.alert(obj_list.action + ": " + data.Message, "w");
                }
    ...
    delete_BaoVeCapCoSo_ThanhVien: function (strNhanSu_Id) {
        var me = this;
        //--Edit
        var obj = {};
        var obj_delete = {
            'action': 'LVLA_BaoVe_CoSo_HoiDong_ThanhVien/Xoa',
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    obj = {
                        content: "TS_BaoVeCapCoSo_NhanSu/Xoa: " + data.Message,
                        code: ""
                    };
                    edu.system.afterComfirm(obj);
                }
            ...
            error: function (er) {
                var obj = {
                    content: "TS_BaoVeCapCoSo_NhanSu/Xoa (er): " + JSON.stringify(er),
                    code: "w"
                };
                edu.system.afterComfirm(obj);
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genTable_BaoVeCapCoSo_ThanhVien: function (data) {
        var me = this;
        //3. create html
        me.arrNhanSu_Id = [];
        $("#tblInputDanhSachNhanSu tbody").html("");
    ...
    --ULR:  Modules
    -------------------------------------------*/
    save_BaoVeCapCoSo_Lich: function (strLich_Id, strDeCuong_Id) {
        var me = this;
        ...
        //--Edit
        var obj_save = {
            'action': 'LVLA_BaoVe_CoSo_Lich/ThemMoi',
        ...
        if (edu.util.checkValue(strId)) {
            obj_save.action = 'LVLA_BaoVe_CoSo_Lich/CapNhat';
    ...
    save_BaoVeLuanVan_Lich_BV: function (strLich_Id, strDeCuong_Id) {
        ...
        var obj_save = {
            'action': 'LVLA_BaoVe_CoSo_Lich/Sua_LVLA_CS_DeTaiSauBaoVe',
    ...
    getList_BaoVeCapCoSo_Lich: function () {
        var me = this;

        //--Edit
        var obj_list = {
            'action': 'LVLA_BaoVe_CoSo_Lich/LayDanhSach',
            'strTuKhoa': edu.util.getValById('txtAAAA'),
            'strLVLA_KeHoach_DeCuong_Id': edu.util.getValById('dropAAAA'),
            'strLVLA_DeCuong_ChinhThuc_Id': me.strBaoVeCapCoSo_Id,
            'strQLSV_NguoiHoc_Id': edu.util.getValById('dropAAAA'),
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.genHTML_BaoVeCapCoSo_Lich_Data(dtResult);
    ...
    delete_BaoVeCapCoSo_Lich: function (strIds) {
        var me = this;
        //--Edit
        var obj = {};
        var obj_delete = {
            'action': 'LVLA_BaoVe_CoSo_Lich/Xoa',
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genHTML_BaoVeCapCoSo_Lich_Data: function (data) {
        var me = this;
        $("#tbl_Lich tbody").html("");
        for (var i = 0; i < data.length; i++) {
            var strId = data[i].ID;
    ...
    genHTML_BaoVeCapCoSo_Lich: function (strId) {
        var me = this;
    ...
    save_XacNhanSanPham: function (strSanPham_Id, strTinhTrang_Id, strNoiDung) {
        ...
        var obj_save = {
            ...
            'strId': "",
            'strSanPham_Id': "LVLA_BaoVe_CoSo_HoiDong_TV" + strSanPham_Id,
