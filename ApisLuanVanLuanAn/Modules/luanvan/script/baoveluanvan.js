...
--Date of updated:
----------------------------------------------*/
function BaoVeLuanVan() { };
BaoVeLuanVan.prototype = {
    strBaoVeLuanVan_Id: '',
    dtBaoVeLuanVan: [],
    dtHeDaoTao: [],
    dtKhoaDaoTao: [],
    ...
    init: function () {
        ...
        $("#btnSave").click(function () {
            me.save_BaoVeLuanVan();
        });
        $(".btnDelete").click(function () {
            if (edu.util.checkValue(me.strBaoVeLuanVan_Id)) {
                edu.system.confirm("Bạn có chắc chắn xóa dữ liệu không?");
                $("#btnYes").click(function (e) {
                    me.delete_BaoVeLuanVan();
                });
                return false;
            }
            else {
        ...
        $("#tblBaoVeLuanVan").delegate(".btnEdit", "click", function () {
            var strId = this.id;
            if (edu.util.checkValue(strId)) {
                me.toggle_form_input();
                me.strBaoVeLuanVan_Id = strId;
                me.getList_BaoVeLuanVan_HuongDan();
                me.getList_BaoVeLuanVan_ThanhVien();
                me.getList_BaoVeLuanVan_Lich();
                edu.util.setOne_BgRow(strId, "tblBaoVeLuanVan");
                me.viewForm_BaoVeLuanVan(edu.util.objGetOneDataInData(strId, me.dtBaoVeLuanVan, "ID"));
                ...
                edu.system.viewFiles("txtFileDinhKem", "DETAISAUBAOVE" + strId, "NCKH_Files");
            }
            else {
                edu.system.alert(edu.constant.getting("NOTIFY", "SELECT_F"));
            }
        ...
        $("#tblInputDanhSachNhanSu").delegate('.btnDeletePoiter', 'click', function () {
            ...
            if (!edu.util.checkValue(strcheck)) {
                ...
                $("#btnYes").click(function (e) {
                    me.delete_BaoVeLuanVan_ThanhVien(strNhanSu_Id);
                });
            }
        });
        ...
        $("#btnThemLich").click(function () {
            ...
            me.genHTML_BaoVeLuanVan_Lich(id, "");
        });
        $("#zone_input_BaoVeLuanVan").delegate(".deleteRowButton", "click", function () {
            var strRowId = this.id;
            $("#tbl_Lich tr[id='" + strRowId + "']").remove();
        });
        $("#zone_input_BaoVeLuanVan").delegate(".deleteHeKhoa", "click", function () {
            var strId = this.id;
            edu.system.confirm(edu.constant.getting("NOTIFY", "CF_DELETE"));
            $("#btnYes").click(function (e) {
                me.delete_BaoVeLuanVan_Lich(strId);
            });
        });
        ...
        $("#zoneBtnXacNhan").delegate('.btnxacnhan', 'click', function (e) {
            ...
            if (me.strBaoVeLuanVan_Id != "") {
                arrChecked_Id = [me.strBaoVeLuanVan_Id];
            } else {
        ...
        edu.system.getList_MauImport("zonebtnBVLV", function (addKeyValue) {
            addKeyValue("strLVLA_KeHoach_DeCuong_Id", edu.util.getValById("dropSearch_KeHoach"));
        });
    ...
    page_load: function () {
        ...
        edu.system.loadToCombo_DanhMucDuLieu("LVLA.VTHDONG", "", "", function (data) {
            main_doc.BaoVeLuanVan.dtVaiTro = data;
        });
        edu.system.loadToCombo_DanhMucDuLieu("LVLA.DGHD", "", "", function (data) {
            main_doc.BaoVeLuanVan.dtDanhGia = data;
        });
    },
    loadBtnXacNhan: function (data) {
        main_doc.BaoVeLuanVan.dtXacNhan = data;
        var row = "";
    ...
    toggle_notify: function () {
        edu.util.toggle_overide("zone-bus", "zone_notify_BaoVeLuanVan");
    },
    toggle_form_input: function () {
        edu.util.toggle_overide("zone-bus", "zone_input_BaoVeLuanVan");
    },
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.dtBaoVeLuanVan = dtResult;
                    me.genTable_BaoVeLuanVan(dtResult, iPager);
                }
                else {
    ...
    save_BaoVeLuanVan: function () {
        var me = this;
        var strId = me.strBaoVeLuanVan_Id;
        $("#tblInputDanhSachNhanSu tbody tr").each(function () {
            var strNhanSu_Id = this.id.replace(/rm_row/g, '');
            me.save_BaoVeLuanVan_ThanhVien(strNhanSu_Id, strId, $(this).attr("name"));
        });
        $("#tbl_Lich tbody tr").each(function () {
            var strLich_Id = this.id.replace(/rm_row/g, '');
            me.save_BaoVeLuanVan_Lich(strLich_Id, strId, $(this).attr("name"));
        });
        me.save_BaoVeLuanVan_Diem();
        setTimeout(function () {
            me.getList_BaoVeLuanVan();
        }, 3000)
        edu.system.saveFiles("txtFileDinhKem","DETAISAUBAOVE" + strId, "LVLA_Files");
    },
    delete_BaoVeLuanVan: function () {
        var me = this;
        //--Edit
        var obj_delete = {
            'action': 'LVLA_DeCuong_DangKy/Xoa',

            'strIds': me.strBaoVeLuanVan_Id,
            'strNguoiThucHien_Id': edu.system.userId
        };
        //default
    ...
    save_BaoVeLuanVan_Diem: function () {
        var me = this;
        var obj_save = {
            'action': 'LVLA_DeCuong_ChinhThuc/Sua_LVLA_DeCuong_CT_Diem',
            'type': 'POST',
            'strId': me.strKetQuaLuanVan_Id,
            'strChucNang_Id': edu.system.strChucNang_Id,
            'strTongDiem': edu.util.getValById('txtTongDiem'),
            'strNguoiThucHien_Id': edu.system.userId,
        };
        //default
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genTable_BaoVeLuanVan: function (data, iPager) {
        var me = this;
        $("#lblBaoVeLuanVan_Tong").html(iPager);
        var jsonForm = {
            strTable_Id: "tblBaoVeLuanVan",
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.BaoVeLuanVan.getList_BaoVeLuanVan()",
                iDataRow: iPager
            },
            sort: true,
            colPos: {
    ...
    viewForm_BaoVeLuanVan: function (data) {
        var me = main_doc.BaoVeLuanVan;
        //view data --Edit
        ...
        me.strKetQuaLuanVan_Id = data.ID;
        edu.util.viewValById("txtTongDiem", data.DIEM);
        if (data.VMACACHLAY === "TUNGTHANHVIEN") $("#txtTongDiem").attr("readonly", "readonly");
        else $("#txtTongDiem").removeAttr("readonly");
    },
    /*------------------------------------------
    --Discription: [2] AccessDB DeTai_ThanhVien
    --ULR:  Modules
    -------------------------------------------*/
    getList_BaoVeLuanVan_HuongDan: function () {
        var me = this;
        ...
        var obj_list = {
            ...
            'strLVLA_DeCuong_DangKy_Id': me.strBaoVeLuanVan_Id,
            'strQLSV_NguoiHoc_Id': edu.util.getValById('dropAAAA'),
            'strNguoiHuongDan_Id': edu.util.getValById('dropAAAA'),
            'strVaiTro_Id': edu.util.getValById('dropAAAA'),
            'strLVLA_KeHoach_DeCuong_Id': me.dtBaoVeLuanVan.find(e => e.ID === me.strBaoVeLuanVan_Id).LVLA_KEHOACH_DECUONG_ID,
            'strLVLA_DeCuong_ChinhThuc_Id': me.strBaoVeLuanVan_Id,
            'strNguoiThucHien_Id': edu.system.userId,
            'pageIndex': 1,
            'pageSize': 100000,
        };
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.genTable_BaoVeLuanVan_HuongDan(dtResult);
                }
                else {
                    edu.system.alert(obj_list.action + ": " + data.Message, "w");
                }
    ...
    genTable_BaoVeLuanVan_HuongDan: function (data) {
        var me = this;
        //3. create html
    ...
    --ULR:  Modules
    -------------------------------------------*/
    save_BaoVeLuanVan_ThanhVien: function (strNhanSu_Id, strBaoVeLuanVan_Id, strId) {
        var me = this;
        ...
        var obj_save = {
            'action': 'LVLA_BaoVe_HoiDong_KetQua/ThemMoi',
            ...
            'strLVLA_DeCuong_ChinhThuc_Id': strBaoVeLuanVan_Id,
        ...
        if (edu.util.checkValue(obj_save.strId)) {
            obj_save.action = 'LVLA_BaoVe_HoiDong_KetQua/CapNhat';
        }
        //default
    ...
    getList_BaoVeLuanVan_ThanhVien: function () {
        var me = this;

        //--Edit
        var obj_list = {
            'action': 'LVLA_BaoVe_HoiDong_KetQua/LayDanhSach',
            'strTuKhoa': edu.util.getValById('txtAAAA'),
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.genTable_BaoVeLuanVan_ThanhVien(dtResult);
                }
                else {
                    edu.system.alert(obj_list.action + ": " + data.Message, "w");
                }
    ...
    delete_BaoVeLuanVan_ThanhVien: function (strNhanSu_Id) {
        var me = this;
        //--Edit
        var obj = {};
        var obj_delete = {
            'action': 'LVLA_BaoVe_HoiDong_KetQua/Xoa',
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    obj = {
                        content: "TS_BaoVeLuanVan_NhanSu/Xoa: " + data.Message,
                        code: ""
                    };
                    edu.system.afterComfirm(obj);
                }
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genTable_BaoVeLuanVan_ThanhVien: function (data) {
        var me = this;
        //3. create html
        me.arrNhanSu_Id = [];
        $("#tblInputDanhSachNhanSu tbody").html("");
        for (var i = 0; i < data.length; i++) {
            ...
            html += '<td><input value="' + edu.util.returnEmpty(data[i].DIEM) + '" type="text" id="txtDiem' + data[i].THANHVIEN_ID + '" class="form-control" /></td>';
            ...
            //html += "<td class='td-left'><select id='xacnhan_" + data[i].THANHVIEN_ID + "'></select></td>";
            ...
            //$("#xacnhan_" + data[i].THANHVIEN_ID).select2();
            ...
            //me.genCombo_XacNhan("danhgia_" + data[i].THANHVIEN_ID, data[i].XACNHAN_ID);
    ...
    genHTML_NhanSu: function (strNhanSu_Id, bcheckadd) {
        ...
        //html += "<td class='td-left'><select id='xacnhan_" + strNhanSu_Id + "'></select></td>";
    ...
    genCombo_XacNhan: function (strXacNhan_Id, default_val) {
        var me = this;
        var obj = {
            data: me.dtXacNhan,
            renderInfor: {
    ...
    save_BaoVeLuanVan_Lich: function (strLich_Id, strDeCuong_Id) {
        ...
        //--Edit
        var obj_save = {
            'action': 'LVLA_BaoVe_Lich/ThemMoi',
        ...
        if (edu.util.checkValue(strId)) {
            obj_save.action = 'LVLA_BaoVe_Lich/CapNhat';
    ...
    save_BaoVeLuanVan_Lich_BV: function (strLich_Id, strDeCuong_Id) {
        ...
        var obj_save = {
            'action': 'LVLA_BaoVe_Lich/Sua_LVLA_DeTaiSauBaoVe',
    ...
    getList_BaoVeLuanVan_Lich: function () {
        var me = this;

        //--Edit
        var obj_list = {
            'action': 'LVLA_BaoVe_Lich/LayDanhSach',
            'strTuKhoa': edu.util.getValById('txtAAAA'),
            'strLVLA_KeHoach_DeCuong_Id': edu.util.getValById('dropAAAA'),
            'strLVLA_DeCuong_ChinhThuc_Id': me.strBaoVeLuanVan_Id,
            'strQLSV_NguoiHoc_Id': edu.util.getValById('dropAAAA'),
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.genHTML_BaoVeLuanVan_Lich_Data(dtResult);
    ...
    delete_BaoVeLuanVan_Lich: function (strIds) {
        var me = this;
        //--Edit
        var obj = {};
        var obj_delete = {
            'action': 'LVLA_BaoVe_Lich/Xoa',
    ...
    --ULR:  Modules
    -------------------------------------------*/
    genHTML_BaoVeLuanVan_Lich_Data: function (data) {
        var me = this;
        $("#tbl_Lich tbody").html("");
        for (var i = 0; i < data.length; i++) {
            var strId = data[i].ID;
    ...
    genHTML_BaoVeLuanVan_Lich: function (strId) {
        var me = this;
    ...
    save_XacNhanSanPham: function (strSanPham_Id, strTinhTrang_Id, strNoiDung) {
        ...
        var obj_save = {
            ...
            'strId': "",
            'strSanPham_Id':"LVLA_BaoVe_HoiDong_KQ"+ strSanPham_Id,
