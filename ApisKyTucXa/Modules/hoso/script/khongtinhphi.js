...
--Note:
----------------------------------------------*/
function KhongTinhPhi() { };
KhongTinhPhi.prototype = {
    dtKhongTinhPhi: [],
    strKhongTinhPhi_Id: '',
    ...
    init: function () {
        ...
        $("#btnSave_KhongTinhPhi").click(function (e) {
            ...
            $("#btnYes").click(function (e) {
                ...
                for (var i = 0; i < arrChecked_Id.length; i++) {
                    me.save_KhongTinhPhi(arrChecked_Id[i]);
                }
            });
        });
        $("[id$=chkSelectAll_KhongTinhPhi]").on("click", function () {
            edu.util.checkedAll_BgRow(this, { table_id: "tblKhongTinhPhi" });
        });
        $("#btnXoaKhongTinhPhi").click(function () {
        ...
        edu.system.getList_MauImport("zonebtnDTOTP");
    },
    ...
    getList_KhongTinhPhi: function (strDanhSach_Id) {
        ...
        //--Edit
        var obj_list = {
            'action': 'KTX_DSKhongTinh/LayDanhSach',
            'type': 'GET',
    ...
    save_KhongTinhPhi: function (strKTX_DoiTuongOKTX_Id) {
        var me = this;
        //--Edit
        var obj_list = {
            'action': 'KTX_DSKhongTinh/ThemMoi',
            'type': 'POST',
        ...
        if (obj_list.strId) {
            obj_list.action = 'KTX_DSKhongTinh/CapNhat';
        }
        //default
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    var strKhongTinhPhi_Id = "";
                    
                    if (obj_list.strId == "") {
                        edu.system.alert("Thêm mới thành công!");
                        strKhongTinhPhi_Id = data.Id;
                    }
                    else {
                        edu.system.alert("Cập nhật thành công!");
                        strKhongTinhPhi_Id = obj_list.strId;
                    }
                }
                else {
    ...
    delete_KhongTinhPhi: function (strId) {
        var me = this;
        //--Edit
        var obj = {};
        var obj_delete = {
            'action': 'KTX_DSKhongTinh/Xoa',
    ...
    viewEdit_KhongTinhPhi: function (data) {
        var me = this;
        //View - Thong tin
    ...
    genTable_ThanhVien: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.KhongTinhPhi.getList_ThanhVien()",
                iDataRow: iPager
            },
            colPos: {
                center: [0, 3, 4]
