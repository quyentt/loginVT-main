...
ChuyenDuLieu.prototype = {
    ...
    init: function () {
        ...
        edu.system.loadToCombo_DanhMucDuLieu("KTX.NVAP", "dropNghiepVu_CDL", "Chọn nghiệp vụ áp dụng");
        ...
        me.objHangDoi = {
            strLoaiNhiemVu: "CHUYENPHIKTXTUDONG",
        ...
        edu.system.getList_MauImport("zonebtnBaoCao_CKT", function (addKeyValue) {
            ...
            addKeyValue("strThoiGianDaoTao", edu.util.getValById("dropThoiGianDaoTao_CDL"));
    ...
    TaoHangDoi_ChuyenDuLieu_TuDong: function () {
        ...
        //--Edit
        var obj_save = {
            'action': 'KTX_HangDoi/TaoHangDoi_ChuyenKeToan_TuDong',
    ...
    getList_KetQua: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'KTX_TinhPhi/LayDSTinhKTX_ChuaKT',
            'strThang': edu.util.getValById('txtThang'),
            'strNam': edu.util.getValById('txtNam'),
            'strNguoiThucHien_Id': edu.system.userId,
            'strNghiepVuApDung_Id': edu.util.getValById('dropNghiepVu_CDL'),
    ...
    genTable_KetQua: function (data, iPager) {
        var me = this;
        $("#tblKetQua_ChuyenKeToan_Tong").html(iPager);
        var strTable_Id = "tblKetQua_ChuyenKeToan";
        var jsonForm = {
            strTable_Id: strTable_Id,
            aaData: data,
            colPos: {
