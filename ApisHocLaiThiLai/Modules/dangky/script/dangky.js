...
DangKy.prototype = {
    ...
    init: function () {
        ...
        edu.system.loadToCombo_DanhMucDuLieu("QLHLTL.TINHTRANGDANGKY", "", "", me.loadBtnXacNhan, "Tất cả tình trạng xác nhận", "HESO1");
        ...
        $("#btnXacNhan_DK").click(function () {
            ...
            me.getList_XacNhanSanPham("", "tblModal_XacNhan");
        });
    ...
    genTable_TongHop: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            bPaginate: {
                strFuntionName: "main_doc.DangKy.getList_TongHop()",
                iDataRow: iPager
            },
            aoColumns: [
                {
    ...
    save_XacNhanSanPham: function (strSanPham_Id, strTinhTrang_Id, strNoiDung) {
        var me = this;
        var obj_save = {
            'action': 'HLTL_XacNhanDangKy/ThemMoi',
            'strId': "",
    ...
    getList_XacNhanSanPham: function (strSanPham_Id, strTable_Id, callback) {
        var me = this;
        var obj_list = {
            'action': 'HLTL_XacNhanDangKy/LayDanhSach',
            'strTuKhoa': edu.util.getValById('txtAAAA'),
            'strNguoiThucHien_Id': edu.system.userId,
            'strsanpham_Id': strSanPham_Id,
