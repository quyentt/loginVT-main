...
DuyetHoSo.prototype = {
    ...
    init: function () {
        var me = this;
        me.page_load();
        edu.system.loadToCombo_DanhMucDuLieu("TUYENSINH.XACNHANDUYETHOSO", "dropSearch_TinhTrang", "", me.loadBtnXacNhan, "Tất cả tình trạng duyệt", "HESO1");
        ...
        $("#dropSearch_TinhTrang").on("select2:select", function () {
            me.getList_HoSo();
        });
        ...
        -------------------------------------------*/
        $("#zoneBtnDuyetHoSo").delegate('.btnxacnhan', 'click', function () {
            ...
            if (me.bcheckM) {
                ...
                for (var i = 0; i < arrChecked_Id.length; i++) {
                    me.save_DuyetHoSo(arrChecked_Id[i], strTinhTrang, strMoTa);
                }
            } else {
                me.save_DuyetHoSo(me.strHoSoDuTuyen_Id, strTinhTrang, strMoTa);
            }
            setTimeout(function () {
                me.getList_HoSo();
            }, 500);
        ...
        $("#btnDuyetHoSo").click(function () {
            $("#modal_DuyetHoSo").modal("show");
            me.getList_DuyetHoSo(me.strHoSoDuTuyen_Id, "tblModal_DuyetHoSo");
            me.bcheckM = false;
        });
        ...
        $("#zone_notify_HoSoTuyenSinh").delegate(".btnDuyetHoSo", "click", function (e) {
    ...
    page_load: function () {
        ...
        setTimeout(function () {
            setTimeout(function () {
                edu.system.viewFiles("txt_ThongTinDinhKem", edu.system.userId, "NS_Files");
            }, 150);
        }, 150);
        edu.extend.setTinhThanh(["txt_NoiSinh", "txt_QueQuan", "txt_HoKhauThuongTru", "txt_DiaChiBaoTin"], 'VD: TP Hà Nội, Quận Cầu Giấy, Dịch Vọng, Số 1 Nguyễn Phong Sắc');
        //end_load: getDetail_HS
        edu.system.loadToCombo_DanhMucDuLieu("TUYENSINH.HOCLUC", "drop_HocLuc_9,drop_HocLuc_12");
        edu.system.loadToCombo_DanhMucDuLieu("TUYENSINH.HANHKIEM", "drop_HanhKiem_9,drop_HanhKiem_12");
        edu.system.loadToCombo_DanhMucDuLieu("TUYENSINH.NGANHNGHE", "drop_NganhNghe,dropSearch_NganhNghe");
        //edu.system.loadToCombo_DanhMucDuLieu("TUYENSINH.XACNHANDUYETHOSO", "dropSearch_TinhTrang");
        edu.system.loadToCombo_DanhMucDuLieu(constant.setting.CATOR.NS.DATO, "drop_DanToc");
        edu.system.loadToCombo_DanhMucDuLieu(constant.setting.CATOR.NS.TOGI, "drop_TonGiao");
        edu.system.loadToCombo_DanhMucDuLieu(constant.setting.CATOR.NS.GITI, "drop_GioiTinh");
        edu.system.loadToCombo_DanhMucDuLieu("TUYENSINH.TRUONGHOC", "dropSearch_TruongHoc", "", me.cbGetList_THPT);
        ...
        //edu.system.loadToCombo_DanhMucDuLieu("TUYENSINH.XACNHANDUYETHOSO", "dropSearch_TinhTrang", "", me.loadBtnDuyetHoSo, "Tất cả tình trạng duyệt");
        //me.getDetail_HS();
    },
    /*------------------------------------------
    ...
    loadBtnXacNhan: function (data) {
        main_doc.DuyetHoSo.dtDuyetHoSo = data;
        var row = "";
    ...
    ----------------------------------------------*/
    save_DuyetHoSo: function (strHoSoDuTuyen_Id, strTinhTrang_Id, strNoiDung) {
        var me = this;
        var obj_save = {
            'action': 'TS_XacNhanDuyetHoSo/ThemMoi',
            'strId': "",
        ...
        edu.system.makeRequest({
            success: function (data) {
                ...
                if (data.Success) {
                    edu.system.alert("Duyệt hồ sơ thành công", "s");
                } else {
    ...
    getList_DuyetHoSo: function (strHoSoDuTuyen_Id, strTable_Id, callback) {
        var me = this;
        var obj_save = {
            'action': 'TS_XacNhanDuyetHoSo/LayDanhSach',
            'strTuKhoa': "",
            'strsanpham_Id': strHoSoDuTuyen_Id,
            'strTinhTrang_Id': "",
            'strNguoiThucHien_Id': '',
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (typeof (callback) == "function") {
                    ...
                    me.genTable_DuyetHoSo(data.Data, strTable_Id);
                }
            },
            error: function (er) {
    ...
    genTable_DuyetHoSo: function (data, strTable_Id) {
        var jsonForm = {
    ...
    rewrite: function () {
        ...
        var arrId = ["txt_HoDem", "txt_Ten", "txt_NgaySinh", "txt_ThangSinh", "txt_NamSinh",
            ...
            "txt_NoiSinh", "txt_QueQuan", "txt_HoKhauThuongTru", "txt_HoTenBo", "txt_HoTenMe",
            ...
            "drop_HocLuc_12", "drop_HanhKiem_12", "txt_NamTotNghiep_12", "txt_ThongTinDinhKem", "drop_TinhTrangHoSo", "txt_GhiChu"];
    ...
    --Author: duyentt
	-------------------------------------------*/
    getList_NguonTuyenSinh: function (data, iPager) {
        var me = this;
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.genCombo_NguonTuyenSinh(dtResult);
                }
                else {
                    edu.system.alert(obj_list.action + ": " + data.Message, "w");
                }
        ...
        var obj = {
            ...
            renderInfor: {
                ...
                Render: function (nrow, aData) {
                    return "<option id='" + aData.ID + "'>" + aData.HODEM + "   " + edu.util.returnEmpty(aData.TEN) + "</option>";
                }
            },
            renderPlace: ["drop_NguonTuyenSinh", "drop_input_NguonTuyenSinh", "dropSearch_DoiTacTuyenSinh"],
    ...
    getList_HoSo: function () {
        ...
        var obj_list = {
            ...
            'strTS_XacNhanDuyetHoSo_Id': edu.util.getValById("dropSearch_TinhTrang"),
    ...
    genTable_HoSo: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.DuyetHoSo.getList_HoSo()",
                iDataRow: iPager
            },
            //bHiddenHeader: true,
            //bHiddenOrder: true,
            ...
            aoColumns: [
                ...
                {
                    "mDataProp": "TS_XACNHANDUYETHOSO_TEN"
                },
                {
                    "mRender": function (nRow, aData) {
    ...
    save_HSDT_THPT: function (str_HSDT_THPT_Id, strHoSoDuTuyen_Id) {
        ...
        //if (edu.util.checkValue(me.strId)) {
    ...
    cbGetList_THPT: function (data) {
        main_doc.DuyetHoSo.dtTHPT = data;
    },
    ...
    genHTML_HoSoGiayTo_Data: function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            row += '<td><input type="text" id="txtSoLuongCanNop' + strHoSoGiayTo_Id + '" value="' + edu.util.returnEmpty(data[i].SOLUONGCANNOP) + '" class="form-control"/></td>';
    ...
    cbGetList_LoaiHoSo: function (data) {
        main_doc.DuyetHoSo.dtLoaiHoSo = data;
    },
