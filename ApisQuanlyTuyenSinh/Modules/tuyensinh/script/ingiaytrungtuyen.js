...
function InGiayTrungTuyen() { };
InGiayTrungTuyen.prototype = {
    strCommon_Id: '',
    tab_actived: [],
    tab_item_actived: [],
    arrValid_HS: [],
    ...
    init: function () {
        ...
        $("#tblHoSoTuyenSinh").delegate('.btnEdit', 'click', function (e) {
            ...
            edu.util.setOne_BgRow(me.strNhanSu_Id, "tblHoSoTuyenSinh");
            me.getDetail_HoSo(me.strHoSoDuTuyen_Id);
            ...
            //$("#zone_input_HoSoTuyenSinh").slideDown();
            me.toggle_form_input();
        });
        /*------------------------------------------
    ...
    page_load: function () {
        ...
        edu.system.loadToCombo_DanhMucDuLieu("TUYENSINH.XACNHANTRUNGTUYEN", "dropSearch_TinhTrangXetTuyen");
        ...
        //me.getDetail_HS();
        edu.system.getList_MauImport("zonebtnBaoCao_TT", function (addKeyValue) {
    ...
    genCombo_HeDaoTao: function (data) {
        var me = main_doc.InGiayTrungTuyen;
        var obj = {
            data: data,
            renderInfor: {
                id: "ID",
    ...
    genTable_HoSo: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            aaData: data,
            bPaginate: {
                strFuntionName: "main_doc.InGiayTrungTuyen.getList_HoSo()",
                iDataRow: iPager
            },
            //bHiddenHeader: true,
            //bHiddenOrder: true,
    ...
    cbGetList_THPT: function (data) {
        main_doc.InGiayTrungTuyen.dtTHPT = data;
    },
    ...
    cbGetList_LoaiHoSo: function (data) {
        main_doc.InGiayTrungTuyen.dtLoaiHoSo = data;
    },
