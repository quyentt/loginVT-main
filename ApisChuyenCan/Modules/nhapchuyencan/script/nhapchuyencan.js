...
--Note:
----------------------------------------------*/
function NhapChuyenCan() { };
NhapChuyenCan.prototype = {
    dtTrangThai: [],
    arrHead_Id: [],
    iMaxLength: 0,
    arrTrangThai_Id: [],
    ...
    init: function () {
        ...
        $("#tblNhapChuyenCan").delegate('.btnDetail', 'click', function (e) {
            $('#myModal').modal('show');
            me.getList_QuanSoTheoLop(this);
        });
        //Xuất báo cáo
        edu.system.getList_MauImport("zonebtnBaoCao_TTQS", function (addKeyValue) {
            main_doc.NhapChuyenCan.arrTrangThai_Id = edu.extend.getCheckedCheckBoxByClassName('ckbDSTrangThaiSV_LHD');
            main_doc.NhapChuyenCan.genHeader_NhapChuyenCan();
            ...
            addKeyValue("strTrangThaiNguoiHoc_Id", main_doc.NhapChuyenCan.arrTrangThai_Id.toString());
            addKeyValue("strTrangThaiNguoiHoc_Ten", main_doc.NhapChuyenCan.arrTrangThai_Ten.toString());
...
;
    ...
    genTable_NhapChuyenCan: function (data, iPager) {
        ...
        var jsonForm = {
            ...
            bPaginate: {
                strFuntionName: "main_doc.NhapChuyenCan.getList_NhapChuyenCan()",
                iDataRow: iPager,
            },
            aaData: data.rs,
            colPos: {
        ...
        for (var i = 0; i < data.rsNgay.length; i++) {
            jsonForm.aoColumns.push({
                "mRender": function (nRow, aData) {
                    ...
                    return '<input type="checkbox" class="checkChuyenCan checkSV' + aData.ID + ' checkNgay' + main_doc.NhapChuyenCan.dtNhapChuyenCan.rsNgay[iThuTu].ID + '" id="chkSelect' + aData.ID + '_' + main_doc.NhapChuyenCan.dtNhapChuyenCan.rsNgay[iThuTu].ID + '" title="' + main_doc.NhapChuyenCan.dtNhapChuyenCan.rsNgay[iThuTu].NGAYGHINHAN + '" />'
                        + '<input style="width: 60%; float: right" id="input_' + aData.ID + '_' + main_doc.NhapChuyenCan.dtNhapChuyenCan.rsNgay[iThuTu].ID + '" />';
                }
            });
