...
YeuCau.prototype = {
    ...
    init: function () {
        ...
        $("#btnSaveLoaiYeuCau").click(function () {
            me.save_LoaiYeuCau();
        });
        edu.system.uploadFiles(["txtDuongDanMau"]);
    },
    popup: function () {
        //show
        $('#myModal').modal('show');
    ...
    save_LoaiYeuCau: function () {
        ...
        var obj_save = {
            ...
            'strDuongDanMauDon': edu.util.getValById('txtDuongDanMau'),
            'strNguoiThucHien_Id': edu.system.userId,
            'dSoNgayTraKetQua': edu.util.getValById('txtSoNgayTraVeKetQua') ? edu.util.getValById('txtSoNgayTraVeKetQua'): 0,
            'dSoGioTraKetQua': edu.util.getValById('txtSoGioTraVeKetQua') ? edu.util.getValById('txtSoGioTraVeKetQua') : 0,
            'dSoPhutTraKetQua': edu.util.getValById('txtSoPhutTraVeKetQua') ? edu.util.getValById('txtSoPhutTraVeKetQua') : 0,
            'strTBKhiDangKyThanhCong': edu.system.getValById('txtThongBaoThanhCong'),
        };
        //if (obj_save.strId) {
        ...
        edu.system.makeRequest({
            success: function (data) {
                if (data.Success) {
                    ...
                    me.getList_LoaiYeuCau();
                    edu.system.saveFiles("txtDuongDanMau", edu.util.getValById('dropSearch_YeuCau'), "SV_Files");
                }
                else {
                    obj_notify = {
                        type: "w",
    ...
    viewForm_LoaiYeuCau: function (data) {
        ...
        edu.system.viewFiles("txtDuongDanMau", edu.util.getValById('dropSearch_YeuCau'), "SV_Files");
        ...
        edu.util.viewValById("txtSoNgayTraVeKetQua", data.SONGAYTRAKETQUA);
        edu.util.viewValById("txtSoGioTraVeKetQua", data.SOGIOTRAKETQUA);
        edu.util.viewValById("txtSoPhutTraVeKetQua", data.SOPHUTTRAKETQUA);
        edu.util.viewValById("txtThongBaoThanhCong", data.THONGBAOKHIDANGKYTHANHCONG);
        edu.util.viewValById("txtDuongDanMau", data.DUONGDANMAUDON);
    ...
    viewForm_YeuCau: function (strId) {
        ...
        edu.util.viewValById("txtDong", data.DONGTHU);
