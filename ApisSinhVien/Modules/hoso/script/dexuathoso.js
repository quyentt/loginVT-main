...
DeXuatHoSo.prototype = {
    ...
    save_DinhDanh: function (strId) {
        ...
        // Skip nếu user không nhập Số định danh — tránh insert NULL vào IDENTIFIER_NO (2026-08-21)
        var strIdentifierNo = edu.system.getValById('txtSoDinhDinh' + strId);
        if (!strIdentifierNo || !strIdentifierNo.trim()) {
            edu.system.start_Progress("zoneprocessXXXX", function () {
                me.save_ThanhCong();
            });
            return;
        ...
        var obj_save = {
            ...
            'strIdentifierNo': strIdentifierNo,
    ...
    save_LienHe: function (strId) {
        ...
        var obj_save = {
            ...
            'strPersonId': me.strDeXuatHoSo_Id,
            'strContactTypeCode': strId,
            'strContactValue': strContactValue,
            'dIsPrimary': $("#checkX" + strId).is(':checked') ? 1 : 0,
            'strEffectiveFrom': edu.system.getValById('txtAAAA'),
            'strEffectiveTo': edu.system.getValById('txtAAAA'),
            'strNguoiThucHien_Id': edu.system.userId,
...
DeXuatHoSo.prototype._populateHeaderBadge = function (person) {
    ...
    el.innerHTML = '';
    if (!person) return;
    // Case-insensitive pick (aData có thể dùng casing khác nhau: FULL_NAME, Full_Name, FullName...)
    ...
    // Fallback: ghép từ hoDem + ten nếu aData không có full name field
    if (!hoTen) {
