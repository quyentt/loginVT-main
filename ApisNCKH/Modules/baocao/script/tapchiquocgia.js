...
TapChiQuocGia.prototype = {
    ...
    init: function () {
        ...
        $("#zoneReport_TCQG").delegate(".btnPrint", "click", function () {
            var strId = this.id;
            strId = edu.util.cutPrefixId(/print_tcqg/g, strId);
            edu.util.objGetDataInData(strId, me.dtReportTemp, "ID", me.report_TCQG);
        });
        /*------------------------------------------
    ...
    page_load: function () {
        var me = this;
        $("#txtSearch_NghiHuu_TuKhoa").focus();
        /*------------------------------------------
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                    ...
                    setTimeout(function () {
                        edu.system.loadToCombo_DanhMucDuLieu("NCKH.TCQG", "dropSearch_BaoCao_PhanLoai", "Chọn phân loại");
                        setTimeout(function () {
                            ...
                            setTimeout(function () {
                                ...
                                setTimeout(function () {
                                    var obj = {
                                        strMaBangDanhMuc: constant.setting.CATOR.SYS.RP.TCQG,
                                        strTenCotSapXep: "",
                                        iTrangThai: 1
                                    };
    ...
    getList_TCQG: function () {
        ...
        var obj_list = {
            ...
            'strDMTapChiQuocGia_Id': edu.util.getValById("dropSearch_BaoCao_TenDMTC"),
    ...
    cbGenLink: function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            html_link += '<li><a id="print_tcqg' + strId + '" class="poiter btnPrint" title="' + strTen + '">' + (i + 1) + ". " + strTen + '</a></li>';
        }
        $("#zoneReport_TCQG").html(html_link);
    },
};