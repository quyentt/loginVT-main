...
TapChiQuocTe.prototype = {
    ...
    init: function () {
        ...
        $("#btnSave_TCQT").click(function () {
            var valid = edu.util.validInputForm(me.arrValid_TCQT);
    ...
    page_load: function () {
        ...
        me.arrValid_TCQT = [
            ...
            { "MA": "txtTCQT_ISSN", "THONGTIN1": "EM" },
            { "MA": "txtTCQT_Ma", "THONGTIN1": "EM" },
        ];
    },
    ...
    rewrite: function () {
        ...
        var arrId = ["txtTCQT_Ten", "txtTCQT_TenTapChi", "txtTCQT_Ma", "dropTCQT_LinhVuc", "txtTCQT_NamCongBo", "txtTCQT_HeSoIF", "txtTCQT_Tap",
            ...
            "txtTCQT_ISSN", "txtTCQT_TongSoTacGia", "txtTCQT_SoTacGiaTrongTruong", "dropDM_ISI", "txtTCQT_ThangCongBo", "txtTCQT_NamHoanThanh", "txtTCQT_SoDOI"];
    ...
    viewEdit_TCQT: function (data) {
        ...
        edu.util.viewValById("txtTCQT_SoTacGiaTrongTruong", dtTapChiQT.CONAMTRONGDANHMUCISI_SCOPUS);
