...
HoiDongDaoDuc.prototype = {
    ...
    init: function () {
        ...
        $("#tblHDDD").delegate(".btnView", "click", function () {
            ...
            if (edu.util.checkValue(strId)) {
                ...
                //me.getList_HDDD_ThanhVien(constant.setting.ACTION.VIEW);
        ...
        $("#tblHDDD").delegate(".btnEdit", "click", function (e) {
            ...
            if (edu.util.checkValue(strId)) {
                ...
                edu.util.setOne_BgRow(strId, "tblHDDD");
                //me.getList_HDDD_ThanhVien(constant.setting.ACTION.EDIT);
            }
            else {
                edu.system.alert(edu.constant.getting("NOTIFY", "SELECT_F"));
            }
    ...
    page_load: function () {
        ...
        //            setTimeout(function () {
        //                edu.system.loadToCombo_DanhMucDuLieu("NCKH.PVHT", "dropSearch_HDDD_PhamVi,dropHDDD_PhamVi", "Tất cả phạm vi");
        //                setTimeout(function () {
        //                    edu.system.loadToCombo_DanhMucDuLieu("NCKH.LVNC", "dropSearch_HDDD_LinhVuc,dropHDDD_LinhVuc_Nganh", "Tất cả lĩnh vực");
        //                    setTimeout(function () {
        //                        var obj = {
        ...
        //                        setTimeout(function () {
        //                            edu.system.loadToCombo_DanhMucDuLieu("NCKH.TCHT", "dropHDDD_DonViToChuc", "Chọn đơn vị tổ chức");
        //                        }, 50);
        //                    }, 50);
        //                }, 50);
        //            }, 50);
    ...
    rewrite: function () {
        ...
        //reset file
        //edu.system.viewFiles("lblHDDD_FileDinhKem", "");
    },
    /*------------------------------------------
