...
TongHop.prototype = {
    ...
    getList_TongHop: function (strDanhSach_Id) {
        ...
        //--Edit
        var obj_list = {
            'action': 'TN_KetQua_CongNhan/LayDanhSach',
    ...
    getList_KetQua: function (strId, strPhanLoai_Id) {
        ...
        //--Edit
        var obj_list = {
            'action': 'TN_KetQua/LayKetQuaXacNhanCuoi',
            'strSanPham_Id': strId,
            ...
            success: function (data) {
                if (data.Success) {
                    for (var i = 0; i < data.Data.length; i++) {
                        ...
                        var check = $("#zone_" + strId + "_" + json.TINHTRANG_ID);
    ...
    getList_TinhTrangQuyDinh: function () {
        ...
        //--Edit
        var obj_list = {
            'action': 'TN_XacNhan/LayDSTinhTrangQuyDinhCuoi',
            'strPhanLoai_Id': edu.util.getValById('dropSearch_PhanLoai'),
        };
